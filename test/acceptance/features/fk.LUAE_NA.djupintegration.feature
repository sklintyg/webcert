# language: sv
@djupintegration @luaena
Egenskap: Djupintegration Läkarutlåtande för aktivitetsersättning vid nedsatt arbetsförmåga
...
Scenario: Informera om patienten har bytt namn
	När att vårdsystemet skapat ett intygsutkast för "Läkarutlåtande för aktivitetsersättning vid nedsatt arbetsförmåga"
...
Scenario: Informera om patienten har fått ett nytt personnummer
	När att vårdsystemet skapat ett intygsutkast för "Läkarutlåtande för aktivitetsersättning vid nedsatt arbetsförmåga" med samordningsnummer
	Och jag går in på intygsutkastet via djupintegrationslänk
    Och jag fyller i alla nödvändiga fält för intyget
    Och jag signerar intyget
