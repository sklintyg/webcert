...
module.exports = function() {
    ...
    this.Given(/^jag går in på (intygsutkastet|intyget)( via djupintegrationslänk| via uthoppslänk)( med annat namn och adress)?$/, function(intygstyp, origin, annatNamnOchAddress) {
        var url;
        var isSMIIntyg;
        if (intyg && intyg.typ) {
