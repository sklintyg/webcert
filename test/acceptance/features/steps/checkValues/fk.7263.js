...
function checkBaserasPa(baserasPa) {
  ...
  if (baserasPa) {
    ...
    if (baserasPa.minUndersokning) {
      promiseArr.push(expect(intygPage.field4b.undersokningAvPatienten.getText()).to.eventually.equal(baserasPa.minUndersokning.datum).then(
          function(value) {
    ...
    if (baserasPa.minTelefonkontakt) {
      promiseArr.push(
          expect(intygPage.field4b.telefonKontakt.getText()).to.eventually.equal(baserasPa.minTelefonkontakt.datum).then(function(value) {
    ...
    if (baserasPa.journaluppgifter) {
      promiseArr.push(
          expect(intygPage.field4b.journaluppgifter.getText()).to.eventually.equal(baserasPa.journaluppgifter.datum).then(function(value) {
...
function checkArbetsformaga(arbetsformaga) {
  ...
  if (arbetsformaga.nedsattMed75) {
    promiseArr.push(
        expect(intygPage.field8b.nedsat75.from.getText()).to.eventually.equal(arbetsformaga.nedsattMed75.from).then(function(value) {
    ...
    promiseArr.push(
        expect(intygPage.field8b.nedsat75.tom.getText()).to.eventually.equal(arbetsformaga.nedsattMed75.tom).then(function(value) {
  ...
  if (arbetsformaga.nedsattMed100) {
    ...
    promiseArr.push(
        expect(intygPage.field8b.nedsat100.tom.getText()).to.eventually.equal(arbetsformaga.nedsattMed100.tom).then(function(value) {
...
module.exports = {
  checkValues: function(intyg) {
    ...
    return Promise.all([
      ...
      //Kontakt med AF
      expect(field6a.kontaktArbetsformedlingen.getText()).to.eventually.equal(
          helpers.boolTillJaNej(intyg.rekommendationer.kontaktMedArbetsformedlingen)).then(function(value) {
      ...
      expect(field6a.kontaktForetagshalsovarden.getText()).to.eventually.equal(
          helpers.boolTillJaNej(intyg.rekommendationer.kontaktMedForetagshalsovard)).then(function(value) {
      ...
      expect(intygPage.field11.block.getText()).to.eventually.contain(helpers.boolTillJaNej(intyg.rekommendationer.resor)).then(
          function(value) {
