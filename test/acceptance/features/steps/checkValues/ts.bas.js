...
function checkKorrektionsglasensStyrka(styrkor) {
  ...
  return expect(tsBasIntygPage.korrektionsglasensStyrka.getText()).to.eventually.equal(helpers.boolTillJaNej(overskrider8dioptrier)).then(
      function(value) {
...
module.exports = {
  checkValues: function(intyg, callback) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.hogerOgautanKorrektion.getText()).to.eventually.equal(intyg.styrkor.houk.toString().replace('.', ',')).then(
            function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.hogerOgamedKorrektion.getText()).to.eventually.equal(intyg.styrkor.homk.toString().replace('.', ',')).then(
            function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.vansterOgautanKorrektion.getText()).to.eventually.equal(intyg.styrkor.vouk.toString().replace('.', ',')).then(
            function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.vansterOgamedKorrektion.getText()).to.eventually.equal(intyg.styrkor.vomk.toString().replace('.', ',')).then(
            function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.binokulartutanKorrektion.getText()).to.eventually.equal(intyg.styrkor.buk.toString().replace('.', ',')).then(
            function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.binokulartmedKorrektion.getText()).to.eventually.equal(intyg.styrkor.bmk.toString().replace('.', ',')).then(
            function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.funktionsnedsattning.getText()).to.eventually.equal(intyg.rorelseorganensFunktioner.nedsattning).then(
            function(value) {
    ...
    if (intyg.rorelseorganensFunktioner.nedsattning === 'Ja') {
      promiseArr.push(expect(tsBasIntygPage.funktionsnedsattningbeskrivning.getText()).to.eventually.equal(
          intyg.rorelseorganensFunktioner.nedsattningBeskrivning).then(function(value) {
      ...
      promiseArr.push(
          expect(tsBasIntygPage.funktionsnedsattningbeskrivning.getText()).to.eventually.equal('Ej angivet').then(function(value) {
    ...
    promiseArr.push(
        expect(tsBasIntygPage.riskfaktorerStroke.getText()).to.eventually.equal(testdataHelper.ejAngivetIfNull(intyg.hjartRisk)).then(
            function(value) {
    ...
    if (intyg.hjartRisk === 'Ja') {
      ...
      promiseArr.push(expect(tsBasIntygPage.beskrivningRiskfaktorer.getText()).to.eventually.equal(testdataHelper.ejAngivetIfNull('')).then(
          function(value) {
    ...
    if (intyg.epilepsi === 'Ja') {
      promiseArr.push(expect(tsBasIntygPage.medvetandestorningbeskrivning.getText()).to.eventually.equal(
          testdataHelper.ejAngivetIfNull(intyg.epilepsiBeskrivning)).then(function(value) {
    ...
    if (intyg.alkoholMissbruk === 'Ja' || intyg.alkoholVard === 'Ja') {
      promiseArr.push(expect(tsBasIntygPage.provtagningBehovs.getText()).to.eventually.equal(
          testdataHelper.ejAngivetIfNull(intyg.alkoholProvtagning)).then(function(value) {
      ...
      promiseArr.push(
          expect(tsBasIntygPage.provtagningBehovs.getText()).to.eventually.equal(testdataHelper.ejAngivetIfNull('')).then(function(value) {
            logger.info('OK - Alkohol provtagning = ' + value);
          }, function(reason) {
            throw ('FEL - Alkohol provtagning = ' + reason);
          }));
    ...
    if (intyg.sjukhusvard === 'Ja') {
      ...
      promiseArr.push(
          expect(tsBasIntygPage.vardinrattning.getText()).to.eventually.equal(intyg.sjukhusvardInrattning).then(function(value) {
      ...
      promiseArr.push(
          expect(tsBasIntygPage.sjukhusvardanledning.getText()).to.eventually.equal(intyg.sjukhusvardAnledning).then(function(value) {
    ...
    if (intyg.ovrigMedicin === 'Ja') {
      promiseArr.push(
          expect(tsBasIntygPage.medicineringbeskrivning.getText()).to.eventually.equal(intyg.ovrigMedicinBeskrivning).then(function(value) {
