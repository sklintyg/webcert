...
var tsdUtkastPageV2 = pages.intyg.ts.diabetes.v2.utkast;
...
module.exports = {
    fillIn: function(intyg) {
        ...
        return new Promise(function(resolve) {
            ...
            return tsdUtkastPageV2.fillInKorkortstyper(intyg.korkortstyper).then(function() {
            ...
            return tsdUtkastPageV2.fillInIdentitetStyrktGenom(intyg.identitetStyrktGenom).then(function() {
            ...
            //Ange allmänt
            return tsdUtkastPageV2.fillInAllmant(intyg.allmant).then(function() {
            ...
            return tsdUtkastPageV2.fillInHypoglykemier(intyg.hypoglykemier).then(function() {
            ...
            return tsdUtkastPageV2.fillInSynintyg(intyg.synintyg).then(function() {
            ...
            return tsdUtkastPageV2.fillInBedomning(intyg.bedomning).then(function() {
