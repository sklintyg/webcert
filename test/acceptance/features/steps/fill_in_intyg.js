...
module.exports = function() {
    ...
    this.Given(/^jag fyller i alla nödvändiga fält för intyget$/, function(callback) {
        ...
        if (intyg.typ === 'Transportstyrelsens läkarintyg') {
            ...
            luseUtkastPage.baseratPa.journaluppg.checkbox.sendKeys(protractor.Key.SPACE);
            luseUtkastPage.baseratPa.anhorigbesk.checkbox.sendKeys(protractor.Key.SPACE);
            browser.ignoreSynchronization = false;
            luseUtkastPage.baseratPa.annat.checkbox.sendKeys(protractor.Key.SPACE);
            luseUtkastPage.baseratPa.annat.annatUnderlag.sendKeys('protractor.Key.SPACE');
            browser.ignoreSynchronization = true;
            ...
            luseUtkastPage.diagnoseCode.sendKeys('A00');
            ...
            luseUtkastPage.sjukdomsforlopp.sendKeys('sjukdomsforlopp');
