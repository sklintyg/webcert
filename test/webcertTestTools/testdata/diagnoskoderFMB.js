...
module.exports = {
    fmbInfo: {
        diagnoser: [{
                ...
                funktionsnedsattning: 'nedsatt rörlighet i den drabbade kroppsdelen',
                ...
                aktivitetsbegransning: 'Vid knäledsskador uppstår svårigheter att både ändra och bibehålla kroppsställning',
            ...
            /*, {
                        ...
                        funktionsnedsattning: 'När smärtan upprepat stör nattvilan kan dagtrötthet och koncentrationssvårigheter förekomma',
