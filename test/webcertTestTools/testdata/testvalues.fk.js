...
var fkValues = {
  ...
  medicinskaBehandlingar: ['Lågkaloridiet', 'Motionsrådgivning', 'Kostrådgivning', 'Kognitiv beteendeinriktad terapi',
...
function getRandomUtredning() {
  return {
    ...
    datum: '2016-04-09',
    infoOmUtredningen: testdataHelper.randomTextString(5, 53)
  };
}
