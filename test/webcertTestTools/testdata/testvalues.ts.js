...
var tsValues = {
  ...
  identitetStyrktGenom: ['ID-kort', 'Företagskort eller tjänstekort', 'Svenskt körkort', 'Personlig kännedom',
    'Försäkran enligt 18 kap. 4§', 'Pass'],
  ...
  getRandomKorkortstyperHogre: function() {
    // Shuffla korkortstyper och returnera slumpad längd på array
    return shuffle(tsValues.korkortstyperHogreBehorighet.slice(0)).slice(0,
        Math.floor(Math.random() * tsValues.korkortstyperHogreBehorighet.length) + 1);
  },
