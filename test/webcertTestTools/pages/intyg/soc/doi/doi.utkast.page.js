...
var doiUtkast = BaseSocUtkast._extend({
  ...
  angeUtlatandeOmDodsorsak: function angeUtlatandeOmDodsorsak(dodsorsak) {
    ...
    return Object.keys(dodsorsak).reduce((prev, sektion) => prev.then(
        () => moveAndSendKeys(utlatandeOmDodsorsakElm[sektion].beskrivning, dodsorsak[sektion].beskrivning).then(function() {
