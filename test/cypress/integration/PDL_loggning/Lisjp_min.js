...
var pdlEventArray = [];
function pdlEvent(env, actType, actLevel, actArgs, vgId_mod, vgNamn_mod, veId_mod, veNamn_mod) {
    var loggHandelse = {
        activity: {
        ...
        user: {
            ...
            assignment: env.vårdpersonal.uppdragsnamn,
        ...
        resources: {
            resource: {
                patient: {
                    patientId: env.vårdtagare.personnummer
                },
                careProvidercareProviderId: env.vårdenhet.vårdgivareId,
                careProvider: {
...
describe('LISJP-intyg', function () {
    ...
    beforeEach(function() {
        ...
        cy.skapaLisjpUtkast(this).then((utkastId) => {
            ...
            pdlEventArray.push(pdlEvent(this, "Skriva", undefined, utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));    
        });
    });
    ...
    it('skapar en minimalt ifylld LISJP', function () {
        ...
        pdlEventArray.push(pdlEvent(this, "Skriva", undefined, this.utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));
        ...
        intyg.signera();
        pdlEventArray.push(pdlEvent(this, "Signera", undefined, this.utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));
        pdlEventArray.push(pdlEvent(this, "Läsa", undefined, this.utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));
        ...
        intyg.skickaTillFk();
        pdlEventArray.push(pdlEvent(this, "Utskrift", "Intyg skickat till mottagare FKASSA", this.utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));
        ...
        cy.fixture('vårdenheter/nmt_vg1_ve1').as('vårdenhet').then(() => {
            ...
            cy.visit(sjfUrl);
            cy.url().should('include', this.utkastId);
            pdlEventArray.push(pdlEvent(this, "Läsa", "Läsning i enlighet med sammanhållen journalföring", this.utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));
            cy.log(this.utkastId + this.vårdenhet.vårdgivareId + this.vårdenhet.vårdgivareNamn + this.vårdenhet.id + this.vårdenhet.namn);

            // Skriver ut intyget samt populerar pdl-arrayen med förväntad logpost "Utskrift"
            intyg.skrivUt("minimalt");
            pdlEventArray.push(pdlEvent(this, "Utskrift", "Intyg utskrivet. Läsning i enlighet med sammanhållen journalföring", 
            this.utkastId, this.vårdenhet.vårdgivareId, this.vårdenhet.vårdgivareNamn, this.vårdenhet.id, this.vårdenhet.namn));
        });
