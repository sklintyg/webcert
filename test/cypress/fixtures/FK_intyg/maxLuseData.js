fk = {
    ...
    "funkNedsättningar": {
        "intellektuell": {
            "text": "WAIS-IV visade allmänna intellektuella nivåer, på genomsnittlig nivå är verbala förmågan starkast, snabbhet som svagast, klart under genomsnittet."
        },
        "kommunikation": {
            "text": "Hyfsad formell och emotionell kontakt. Undviker ögonkontakt. Isoleringstendenser. Begränsad social förmåga."
        },
        "koncentration": {
            "text": "QB-test visade normala prestation på aktivitet och uppmärksamhet. Impulsivitet kan tolkas som lätt avvisande. Låg initiativförmåga. Inga tecken på perceptionsstörningar."
        },
        "psykisk": {
            "text": "Nedstämt stämningsläge, orkeslöshet, trötthet."
        },
        "sinnesfunktionerOchSmärta": {
    ...
    "aktivitetsbegränsningar": {
        "text": "Stora svårigheter att på egen hand sköta sitt hem och planera aktiviteter på vardagarna. Klarar med lite stöd att laga mat och klippa gräset, men upplever att tvättning är alldeles för komplicerat. Svårt att sköta sin egen hygien. Svårt att genomföra aktiviteter, särskilt utanför hemmet. Svårt med sociala kontakter."
    },
    ...
    "medicinskBehandling": {
        ...
        "substansintag": {
            "text": "Medicinerat med Sertralin 150 mg, god men inte fullständig effekt. Har själv slutat med medicinering p.g.a. biverkningar."
        }
    },
