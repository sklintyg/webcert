...
public final class AuthoritiesConfiguration {
  ...
  @JsonProperty private Date released;
  @JsonProperty private String changedby;
  @JsonProperty private List<String> knownRequestOrigins;
  @JsonProperty private List<String> knownRoles;
  @JsonProperty private List<String> knownPrivileges;
  ...
  @JsonProperty private List<Title> titles;
  @JsonProperty private List<TitleCode> titleCodes;
