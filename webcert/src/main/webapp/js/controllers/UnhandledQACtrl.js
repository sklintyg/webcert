define(['angular'], function(angular) {
     ...
     */
    return [
        '$scope', '$window', '$location', '$log', '$timeout', '$filter', '$cookieStore', 'ManageCertificate',
        'fragaSvarCommonService', 'QuestionAnswer', 'wcDialogService',
        function($scope, $window, $location, $log, $timeout, $filter, $cookieStore, ManageCertificate,
            fragaSvarCommonService, QuestionAnswer, wcDialogService) {
