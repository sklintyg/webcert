...
], function(angular, ManageCertificate, dialogService, User) {
    'use strict';

    var moduleName = 'wc.UnsignedCertCtrl';

    /*
     * Controller for logic related to listing unsigned certs
     */
    angular.module(moduleName, [ dialogService, ManageCertificate, User ]).
        controller(moduleName, [ '$cookieStore', '$filter', '$location', '$log', '$scope', '$timeout',
            '$window', dialogService, ManageCertificate, User,
