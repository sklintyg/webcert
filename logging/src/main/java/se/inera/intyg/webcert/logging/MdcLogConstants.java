...
public class MdcLogConstants {
  ...
  public static final String EVENT_CERTIFICATE_CARE_PROVIDER_ID =
      "event.certificate.care_provider.id";
  ...
  public static final String EVENT_STATUS_UPDATE_CORRELATION_ID =
      "event.status_update.correlation_id";
