...
const CertificateSidePanel: React.FC<CertificateSidePanelProp> = (props) => {
  ...
  return (
    <>
      <Paper style={{ overflowY: "auto", height: "100%", display: "flex", flexDirection: "column" }}>
        <Tabs classes={{ flexContainer: styles.flexContainer }} value={0} indicatorColor="primary" style={{ border: "1px solid #cdced6", alignItems: "center" }}>
        ...
        <Box color={"#00a9a7"} border={"1px solid #cdced6"} position={"sticky"} bottom={"0"} padding={"20px"}>
