...
angular.module('webcert').constant('webcert.messages', {
  'sv': {
    ...
    'db.label.bodyText': 'När dödsbeviset signeras, skickas det samtidigt till Skatteverket och dödsfallet registreras.<br><br>Ett dödsbevis utfärdat på fel person får stora konsekvenser för den enskilde personen. <br><br>Kontrollera därför en extra gång att personuppgifterna stämmer.<br><br>',
    'db.draft.label.bodyText': 'När dödsbeviset signeras, skickas det samtidigt till Skatteverket och dödsfallet registreras.<br><br>Ett dödsbevis utfärdat på fel person får stora konsekvenser för den enskilde personen. <br><br>Kontrollera därför en extra gång att personuppgifterna stämmer.<br><br><b>Om fel personuppgifter visas ovan, välj Radera.</b><br><br>',
