...
remoteLog("outstandingRequestCount-- "+outstandingRequestCount);
      if (outstandingRequestCount === 0) {
        while(outstandingRequestCallbacks.length) {
          try {
remoteLog("calling callback");
...
remoteLog("notifyWhenNoOutstandingRequests request");
    ...
    if (outstandingRequestCount === 0) {
remoteLog("outstandingRequestCount === 0, calling callback");
      callback();
    } else {
