...
public class CSIntegrationRequestFactory {
  ...
  public CreateCertificateRequestDTO createCertificateRequest(
      CertificateModelIdDTO modelId, String patientId) {
  ...
  public CreateCertificateRequestDTO createDraftCertificateRequest(
      CertificateModelIdDTO modelId, Intyg certificate, IntygUser user) {
  ...
  public CreateCertificateFromTemplateRequestDTO createCertificateFromTemplateRequest(
      String patientId, IntegrationParameters integrationParameters) {
  ...
  public SaveCertificateRequestDTO saveRequest(
      Certificate certificate, String personId, String externalReference) {
  ...
  private GetUnitCertificatesRequestDTO getUnitCertificatesRequestDTO(
    ...
    final var patient =
        queryCriteria.getPersonId() == null
            ? null
            : certificateServicePatientHelper.get(
                createPatientId(queryCriteria.getPersonId().getId()));
  ...
  public PrintCertificateRequestDTO getPrintCertificateRequest(
      String additionalInfoText, String patientId) {
  ...
  public RevokeCertificateRequestDTO revokeCertificateRequest(String reason, String message) {
    return RevokeCertificateRequestDTO.builder()
        .revoked(
            RevokeInformationDTO.builder().reason(convertReason(reason)).message(message).build())
        .unit(certificateServiceUnitHelper.getUnit())
        .careUnit(certificateServiceUnitHelper.getCareUnit())
        .careProvider(certificateServiceUnitHelper.getCareProvider())
        .user(certificateServiceUserHelper.get())
  ...
  public ReplaceCertificateRequestDTO replaceCertificateRequest(
      Patient patient, IntegrationParameters integrationParameters) {
  ...
  public RenewCertificateRequestDTO renewCertificateRequest(
      Patient patient, IntegrationParameters integrationParameters) {
  ...
  public RenewLegacyCertificateRequestDTO renewLegacyCertificateRequest(
      Patient patient,
      IntegrationParameters integrationParameters,
      CertificateModelIdDTO certificateModelId,
      CertificateStatus status,
      Unit unit,
      PrefillXmlDTO xmlPrefill) {
    return RenewLegacyCertificateRequestDTO.builder()
        ...
        .prefillXml(xmlPrefill)
        .build();
  }

  public CertificateComplementRequestDTO complementCertificateRequest(
      Patient patient, IntegrationParameters integrationParameters) {
  ...
  public GetCitizenCertificatePdfRequestDTO getCitizenCertificatePdfRequest(
      String personId, String customizationId) {
    ...
    return GetCitizenCertificatePdfRequestDTO.builder()
        .personId(
            PersonIdDTO.builder()
                ...
                .type(
                    isCoordinationNumber(citizenPersonId)
                        ? PersonIdType.COORDINATION_NUMBER
                        : PersonIdType.PERSONAL_IDENTITY_NUMBER)
                .build())
  ...
  public CreateMessageRequestDTO createMessageRequest(
      QuestionType type, String message, String personId) {
  ...
  public CertificatesWithQARequestDTO getCertificatesWithQARequestDTO(List<String> certificateIds) {
    return CertificatesWithQARequestDTO.builder().certificateIds(certificateIds).build();
  }
  ...
  public LockDraftsRequestDTO getLockDraftsRequestDTO(int lockedAfterDay) {
    ...
    return LockDraftsRequestDTO.builder().cutoffDate(cutoffDate).build();
  }

  public ListObsoleteDraftsRequestDTO getListObsoleteDraftsRequestDTO(LocalDateTime cutoffDate) {
    return ListObsoleteDraftsRequestDTO.builder().cutoffDate(cutoffDate).build();
  }

  public DisposeObsoleteDraftsRequestDTO getDisposeObsoleteDraftRequestDTO(String certificateId) {
    return DisposeObsoleteDraftsRequestDTO.builder().certificateId(certificateId).build();
  }
  ...
  public UpdateWithCandidateCertificateRequestDTO updateWithCandidateCertificateRequestDTO(
      String personId, IntegrationParameters integrationParameters) {
