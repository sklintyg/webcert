...
public class CertificateRenewFunction {
  ...
  private static final String RENEW_DESCRIPTION =
      "Skapar en redigerbar kopia av intyget på den enhet som du är inloggad på.";
  public static final String EVENTUAL_COMPLEMENTARY_REQUEST_WONT_BE_MARKED_READY =
      "Eventuell kompletteringsbegäran kommer inte " + "att klarmarkeras.";
  public static final String EVENTUAL_COMPLEMENTARY_WILL_BE_MARKED_READY =
  ...
  public static boolean validate(
    ...
    return validateStatus(status)
        && authoritiesHelper.isFeatureActive(
            AuthoritiesConstants.FEATURE_FORNYA_INTYG, certificateType);
  }

  public static ResourceLinkDTO createResourceLink(
      String loggedInUnitId, String savedUnitId, String certificateType) {
  ...
  private static boolean includesChildRelation(
  ...
  private static String getRenewBody(
      String loggedInUnitId, String savedUnitId, String certificateType) {
  ...
  private static Boolean isUserAndCertificateFromSameCareUnit(
      String loggedInCareUnitId, String savedUnitId) {
