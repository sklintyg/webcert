...
public class StatsResponse {
  ...
  public void setTotalNbrOfUnhandledFragaSvarOnOtherThanSelected(
      long totalNbrOfUnhandledFragaSvarOnOtherThanSelected) {
    this.totalNbrOfUnhandledFragaSvarOnOtherThanSelected =
        totalNbrOfUnhandledFragaSvarOnOtherThanSelected;
  }
  ...
  public void setTotalNbrOfUnhandledFragaSvarOnSelected(
      long totalNbrOfUnhandledFragaSvarOnSelected) {
  ...
  public void setTotalNbrOfUnsignedDraftsOnOtherThanSelected(
      long totalNbrOfUnsignedDraftsOnOtherThanSelected) {
  ...
  public String toString() {
    return "StatsResponse [totalNbrOfUnhandledFragaSvarOnOtherThanSelected="
        + totalNbrOfUnhandledFragaSvarOnOtherThanSelected
        + ", totalNbrOfUnhandledFragaSvarOnSelected="
        + totalNbrOfUnhandledFragaSvarOnSelected
        + ", totalNbrOfUnsignedDraftsOnOtherThanSelected="
        + totalNbrOfUnsignedDraftsOnOtherThanSelected
        + ", totalNbrOfUnsignedDraftsOnSelected="
        + totalNbrOfUnsignedDraftsOnSelected
        + ", vardgivare="
        + vardgivare
        + "]";
