...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.GetCandidateCertificateRequestDTO.GetCandidateCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = GetCandidateCertificateRequestDTOBuilder.class)
@Value
@Builder
public class GetCandidateCertificateRequestDTO {
    ...
    public static class GetCandidateCertificateRequestDTOBuilder {
