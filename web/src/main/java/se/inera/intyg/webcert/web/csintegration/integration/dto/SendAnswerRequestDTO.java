...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.SendAnswerRequestDTO.SendAnswerRequestDTOBuilder;
...
@JsonDeserialize(builder = SendAnswerRequestDTOBuilder.class)
@Value
@Builder
public class SendAnswerRequestDTO {
    ...
    public static class SendAnswerRequestDTOBuilder {
