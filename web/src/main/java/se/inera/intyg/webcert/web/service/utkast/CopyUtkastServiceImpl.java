...
public class CopyUtkastServiceImpl implements CopyUtkastService {
    ...
    public CreateCompletionCopyResponse createCompletion(CreateCompletionCopyRequest copyRequest) {
        ...
        try {
            ...
            Utkast savedUtkast = saveAndNotify(builderResponse, user, EventKod.KOMPLETTERAR, originalIntygId);
    ...
    public CreateRenewalCopyResponse createRenewalCopy(CreateRenewalCopyRequest copyRequest) {
        ...
        try {
            ...
            Utkast savedUtkast = saveAndNotify(builderResponse, user, EventKod.FORLANGER, originalIntygId);
    ...
    public CreateReplacementCopyResponse createReplacementCopy(CreateReplacementCopyRequest replacementRequest) {
        ...
        try {
            ...
            Utkast savedUtkast = saveAndNotify(builderResponse, user, EventKod.ERSATTER, originalIntygId);
    ...
    public CreateUtkastFromTemplateResponse createUtkastFromSignedTemplate(CreateUtkastFromTemplateRequest templateRequest) {
        ...
        try {
            ...
            Utkast savedUtkast = saveAndNotify(builderResponse, user, EventKod.SKAPATFRAN, originalIntygId);
    ...
    private Utkast saveAndNotify(UtkastBuilderResponse builderResponse, WebCertUser user, EventKod eventKod, String originalIntygId) {
        ...
        utkastEventService.createUtkastEventFromCopyUtkast(savedUtkast, user.getHsaId(), eventKod, originalIntygId);
