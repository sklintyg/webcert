...
public class SignAggregator implements UnderskriftService {
  ...
  public SignaturBiljett startSigningProcess(
    ...
    final var signaturBiljett =
        signServiceForCS.startSigningProcess(
            intygsId, intygsTyp, version, signMethod, ticketID, userIpAddress);

    return signaturBiljett != null
        ? signaturBiljett
        : signServiceForWC.startSigningProcess(
            intygsId, intygsTyp, version, signMethod, ticketID, userIpAddress);
  }
  ...
  public SignaturBiljett fakeSignature(
    ...
    final var signaturBiljett =
        signServiceForCS.fakeSignature(intygsId, intygsTyp, version, ticketId);
