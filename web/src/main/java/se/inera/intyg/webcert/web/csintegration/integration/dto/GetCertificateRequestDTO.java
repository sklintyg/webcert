...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.GetCertificateRequestDTO.GetCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = GetCertificateRequestDTOBuilder.class)
@Value
@Builder
public class GetCertificateRequestDTO {
    ...
    public static class GetCertificateRequestDTOBuilder {
