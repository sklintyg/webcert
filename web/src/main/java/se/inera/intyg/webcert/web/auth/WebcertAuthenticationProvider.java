...
public class WebcertAuthenticationProvider extends SAMLAuthenticationProvider {
    ...
    private boolean isSithsAuthentication(AuthnStatement statement) {
        ...
        var authnContextClassRef = statement.getAuthnContext().getAuthnContextClassRef().getAuthnContextClassRef();
        return SITHS_AUTHN_CLASSES.contains(authnContextClassRef);
    }
}
