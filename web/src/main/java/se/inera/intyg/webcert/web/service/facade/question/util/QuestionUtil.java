...
public final class QuestionUtil {
  ...
  public static Predicate<Arende> isQuestion() {
    return arende ->
        (arende.getSvarPaId() == null || arende.getSvarPaId().isBlank())
            && (arende.getPaminnelseMeddelandeId() == null
                || arende.getPaminnelseMeddelandeId().isBlank());
  }
  ...
  public static Predicate<ArendeDraft> isAnswerDraft() {
    return arendeDraft ->
        arendeDraft.getQuestionId() != null && !arendeDraft.getQuestionId().isBlank();
  }
