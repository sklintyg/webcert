 ...
 *
 * <p>These types can be resolved on the client side to assess if the user has correct access.
 */
public enum ActionLinkType {
  ...
  /**
   * Answer a complement question related to a certificate with a message (and not a new
   * certificate).
   */
