...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.ReplaceCertificateRequestDTO.ReplaceCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = ReplaceCertificateRequestDTOBuilder.class)
@Value
@Builder
