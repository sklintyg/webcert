...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.SendCertificateRequestDTO.SendCertificiateRequestDTOBuilder;
...
@JsonDeserialize(builder = SendCertificiateRequestDTOBuilder.class)
@Value
@Builder
public class SendCertificateRequestDTO {
    ...
    public static class SendCertificiateRequestDTOBuilder {
