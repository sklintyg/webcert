...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.UpdateWithCandidateCertificateRequestDTO.UpdateWithCandidateCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = UpdateWithCandidateCertificateRequestDTOBuilder.class)
@Value
@Builder
public class UpdateWithCandidateCertificateRequestDTO {
    ...
    public static class UpdateWithCandidateCertificateRequestDTOBuilder {
