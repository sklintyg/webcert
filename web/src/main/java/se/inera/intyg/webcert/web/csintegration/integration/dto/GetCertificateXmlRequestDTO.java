...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.GetCertificateXmlRequestDTO.GetCertificiateXmlRequestDTOBuilder;
...
@Value
@Builder
public class GetCertificateXmlRequestDTO {
