...
public final class IntegrationParameters implements Serializable {
  ...
  private String beforeAlternateSsn =
      ""; // Sätts när alternateSsn skiljer från intygets patientId för att kunna visa det i
  // utkastet.

  @JsonIgnore private IntegrationState state = new IntegrationState();
