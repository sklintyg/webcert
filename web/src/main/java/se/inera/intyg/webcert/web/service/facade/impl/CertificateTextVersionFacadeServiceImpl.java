...
public class CertificateTextVersionFacadeServiceImpl
    implements CertificateTextVersionFacadeService {

  private static final Logger LOG =
      LoggerFactory.getLogger(CertificateTextVersionFacadeServiceImpl.class);
  ...
  public Utkast upgradeToLatestMinorTextVersion(Utkast utkast) {
    ...
    final var latestTextVersion =
        intygTextsService.getLatestVersionForSameMajorVersion(certificateType, objectTextVersion);
    ...
    try {
      ...
      logUpdatedTextVersion(
          certificateId,
          certificateType,
          objectTextVersion,
          latestTextVersion,
          jsonModelTextVersion);
      ...
      LOG.error(
          "Could not confirm latest minor text version for certificate {} of type {} with text version {}.",
          certificateId,
          certificateType,
          objectTextVersion,
          e);
  ...
  private String getModelTextVersion(Utkast utkast)
  ...
  private boolean isLatestTextVersion(
      String objectTextVersion, String modelTextVersion, String latestTextVersion) {
    return objectTextVersion.equals(latestTextVersion)
  ...
  private void logUpdatedTextVersion(
      String certificateId,
      String certificateType,
      String objectTextVersion,
      String latestTextVersion,
      String jsonModelTextVersion) {
    final var previousVersion =
        !objectTextVersion.equals(latestTextVersion) ? objectTextVersion : jsonModelTextVersion;
    LOG.info(
        "Updating text version for certificate {} of type {} from version {} to version {}.",
        certificateId,
        certificateType,
        previousVersion,
        latestTextVersion);
