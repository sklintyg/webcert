...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.DeleteMessageRequestDTO.DeleteMessageRequestDTOBuilder;
...
@JsonDeserialize(builder = DeleteMessageRequestDTOBuilder.class)
@Value
@Builder
public class DeleteMessageRequestDTO {
    ...
    public static class DeleteMessageRequestDTOBuilder {
