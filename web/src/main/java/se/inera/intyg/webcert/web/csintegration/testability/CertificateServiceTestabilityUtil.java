...
public class CertificateServiceTestabilityUtil {
  ...
  public CertificateServiceTestabilityUtil(
      ...
      CertificateServiceUserBuilder certificateServiceUserBuilder) {
  ...
  public String create(CertificateServiceCreateRequest certificateServiceCreateRequest) {
    ...
    final var certificate =
        csTestabilityIntegrationService.createCertificate(certificateRequestDTO);
    return certificate.getMetadata().getId();
  }

  private CreateCertificateRequestDTO createRequest(
      CertificateServiceCreateRequest certificateServiceCreateRequest) {
    ...
    return CreateCertificateRequestDTO.builder()
        ...
        .patient(
            certificateServicePatientHelper.get(
                certificateServiceCreateRequest.getPatient().getPersonId()))
