...
public class CertificateAccessServiceImpl implements CertificateAccessService {
  ...
  @Autowired
  public CertificateAccessServiceImpl(
  ...
  @Override
  public AccessResult allowToPrint(
  ...
  @Override
  public AccessResult allowToApproveReceivers(
  ...
  @Override
  public AccessResult allowToAnswerComplementQuestion(
  ...
  @Override
  public AccessResult allowToCreateDraftFromSignedTemplate(
      AccessEvaluationParameters accessEvaluationParameters) {
    return getAccessServiceEvaluation()
        .given(
            getUser(), getCertificateTypeToCreate(accessEvaluationParameters.getCertificateType()))
        .feature(AuthoritiesConstants.FEATURE_HANTERA_INTYGSUTKAST)
        .blockFeatureIf(
            AuthoritiesConstants.FEATURE_ENABLE_BLOCK_ORIGIN_NORMAL,
            getUser().getOrigin().equalsIgnoreCase(UserOriginType.NORMAL.name()))
   ...
   *
   * @param sourceCertificateType Certificate type that will be used as template to create a new
   *     draft.
  ...
  @Override
  public AccessResult allowToAnswerAdminQuestion(
      AccessEvaluationParameters accessEvaluationParameters) {
    return getAccessServiceEvaluation()
        .given(getUser(), accessEvaluationParameters.getCertificateType())
        .feature(AuthoritiesConstants.FEATURE_HANTERA_FRAGOR)
  ...
  public AccessResult allowToReadQuestions(AccessEvaluationParameters accessEvaluationParameters) {
    return getAccessServiceEvaluation()
        ...
        .checkInactiveCareUnit(true)
        .excludeCertificateTypesForInactive(
            LisjpEntryPoint.MODULE_ID,
            Fk7263EntryPoint.MODULE_ID,
            LuaefsEntryPoint.MODULE_ID,
            LuaenaEntryPoint.MODULE_ID,
  ...
  @Override
  public AccessResult allowToForwardQuestions(
      AccessEvaluationParameters accessEvaluationParameters) {
    return getAccessServiceEvaluation()
        .given(getUser(), accessEvaluationParameters.getCertificateType())
        .feature(AuthoritiesConstants.FEATURE_HANTERA_FRAGOR)
  ...
  @Override
  public AccessResult allowToSetComplementAsHandled(
      AccessEvaluationParameters accessEvaluationParameters) {
    return getAccessServiceEvaluation()
        .given(getUser(), accessEvaluationParameters.getCertificateType())
        .feature(AuthoritiesConstants.FEATURE_HANTERA_FRAGOR)
  ...
  @Override
  public AccessResult allowToSetQuestionAsHandled(
      AccessEvaluationParameters accessEvaluationParameters) {
    return getAccessServiceEvaluation()
        .given(getUser(), accessEvaluationParameters.getCertificateType())
        .feature(AuthoritiesConstants.FEATURE_HANTERA_FRAGOR)
