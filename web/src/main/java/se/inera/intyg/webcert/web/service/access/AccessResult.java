 ...
 * message from the access evaluation including convenience methods.
 */
public final class AccessResult {
  ...
  /**
   * Create access result. Use this method when creating access result that denies access. If access
   * is allowed, then use noProblem().
   *
   ...
   */
  @NotNull public AccessResultCode getCode() {
    return code;
  }
