...
public final class AuthConstants {
  ...
  public static final String ATTRIBUTE_EMPLOYEE_HSA_ID =
  ...
  public static final String SAML_2_0_NAMEID_FORMAT_TRANSIENT =
  ...
  public static final String METADATA_LOCATION_STRING_TEMPLATE =
      "https://%s/saml2/service-provider-metadata/%s";
  public static final String AUTHN_CONTEXT_CLASS_REF_REGEX =
      "(?<=<saml2:AuthnContextClassRef>).*(?=</saml2:AuthnContextClassRef>)";
  public static final Pattern AUTHN_CONTEXT_CLASS_REF_PATTERN =
      Pattern.compile(AUTHN_CONTEXT_CLASS_REF_REGEX);
  ...
  public static final List<String> SITHS_AUTHN_CLASSES =
      List.of("http://id.sambi.se/loa/loa2", "http://id.sambi.se/loa/loa3");

  public static final List<String> ELEG_AUTHN_CLASSES =
      List.of(
