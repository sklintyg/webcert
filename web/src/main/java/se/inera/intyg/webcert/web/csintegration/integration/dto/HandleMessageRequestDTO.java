...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.HandleMessageRequestDTO.HandleMessageRequestDTOBuilder;
...
@JsonDeserialize(builder = HandleMessageRequestDTOBuilder.class)
@Value
@Builder
