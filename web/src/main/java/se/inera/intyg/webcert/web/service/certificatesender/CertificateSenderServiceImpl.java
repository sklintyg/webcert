...
public class CertificateSenderServiceImpl implements CertificateSenderService {
  ...
  public void sendCertificate(
      String intygsId, Personnummer personId, String jsonBody, String recipientId) {
  ...
  public void sendCertificate(
    ...
    send(
        new SendCertificateMessageCreator(
            intygsId, personId, jsonBody, recipientId, logicalAddress, delay));
  }

  @Override
  public void revokeCertificate(
      String intygsId, String xmlBody, String intygsTyp, String intygsTypVersion) {
    send(
        new RevokeCertificateMessageCreator(
            intygsId, xmlBody, logicalAddress, intygsTyp, intygsTypVersion));
  }
  ...
  public void sendRegisterApprovedReceivers(String intygsId, String intygsTyp, String jsonBody) {
    send(
        new RegisterApprovedReceiversMessageCreator(intygsId, intygsTyp, jsonBody, logicalAddress));
  }
  ...
  static final class StoreCertificateMessageCreator implements MessageCreator {
    ...
    private StoreCertificateMessageCreator(
        String intygsId, String body, String intygsTyp, String logicalAddress) {
  ...
  static final class SendCertificateMessageCreator implements MessageCreator {
    ...
    private SendCertificateMessageCreator(
        String intygsId,
  ...
  static final class RevokeCertificateMessageCreator implements MessageCreator {
    ...
    private RevokeCertificateMessageCreator(
        String intygsId,
        String xmlBody,
        String logicalAddress,
        String intygsTyp,
  ...
  static final class SendMessageToRecipientMessageCreator implements MessageCreator {
    ...
    private SendMessageToRecipientMessageCreator(
        String intygsId, String xmlBody, String logicalAddress) {
      this.intygsId = intygsId;
      this.xmlBody = xmlBody;
      this.logicalAddress = logicalAddress;
    }
  ...
  static final class RegisterApprovedReceiversMessageCreator implements MessageCreator {
    ...
    private RegisterApprovedReceiversMessageCreator(
        String intygsId, String intygsTyp, String jsonBody, String logicalAddress) {
      this.intygsId = intygsId;
      this.intygsTyp = intygsTyp;
    ...
    public Message createMessage(Session session) throws JMSException {
      ...
      message.setStringProperty(
          Constants.MESSAGE_TYPE, Constants.REGISTER_APPROVED_RECEIVERS_MESSAGE);
      message.setStringProperty(Constants.INTYGS_ID, intygsId);
      message.setStringProperty(Constants.INTYGS_TYP, intygsTyp);
      message.setStringProperty(Constants.LOGICAL_ADDRESS, logicalAddress);
      return message;
