...
public interface FmbSjukfallService {
   ...
   *
   * <p>The service will calculate based on active sjukfall registrered for the patient, that are
   * related to the list of periods.
   *
   * <p>E.g. If the passed period is 2020-01-15 - 2020-01-25, the service will check to see if the
   * period is related to a sjukfall that is withing the starting date (2020-01-15) and MAX_GAP
   * (e.g. 5 days). Total time in days will include the sjukfall, but make sure that any overlapping
