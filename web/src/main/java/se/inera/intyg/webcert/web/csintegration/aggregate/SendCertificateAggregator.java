...
public class SendCertificateAggregator implements SendCertificateFacadeService {
  ...
  public SendCertificateAggregator(
      @Qualifier("sendCertificateFromWebcert") SendCertificateFacadeService sendCertificateFromWebcert,
      @Qualifier("sendCertificateFromCertificateService") SendCertificateFacadeService sendCertificateFromCertificateService) {
  ...
  public String sendCertificate(String certificateId) {
    ...
    return responseFromCS != null
        ? responseFromCS
        : sendCertificateFromWebcert.sendCertificate(certificateId);
  }
}
