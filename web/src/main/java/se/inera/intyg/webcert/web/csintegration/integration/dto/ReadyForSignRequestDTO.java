...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.ReadyForSignRequestDTO.ReadyForSignRequestDTOBuilder;
...
@JsonDeserialize(builder = ReadyForSignRequestDTOBuilder.class)
@Value
@Builder
public class ReadyForSignRequestDTO {
    ...
    public static class ReadyForSignRequestDTOBuilder {
