...
public interface DiagnosService {
  ...
  /**
   * Searches the repository for codes beginning with the codeFragment. Limits the number of matches
   * returned.
   *
   * @param codeFragment The string to search codes by. The string must at least correspond to the
   *     pattern 'A01'.
   * @param codeSystem The code system to which the code belongs (i.e ICD-10-SE or KSH97P)
  ...
  /**
   * Searches the repository for descriptions matching searchString. Limits the number of matches
   * returned.
   *
   ...
   * @param nbrOfResults The number of results to return, must be larger than 0.
   */
  DiagnosResponse searchDiagnosisByDescription(
      String searchString, String codeSystem, int nbrOfResults);
