...
import se.inera.intyg.webcert.web.csintegration.integration.dto.SaveMessageRequestDTO.SaveMessageRequestDTOBuilder;
...
@JsonDeserialize(builder = SaveMessageRequestDTOBuilder.class)
@Value
@Builder
public class SaveMessageRequestDTO {
    ...
    public static class SaveMessageRequestDTOBuilder {
