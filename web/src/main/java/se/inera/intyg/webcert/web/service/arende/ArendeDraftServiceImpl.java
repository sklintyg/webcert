...
public class ArendeDraftServiceImpl implements ArendeDraftService {
  ...
  public List<ArendeDraft> listAnswerDrafts(String intygId) {
    return arendeDraftRepository.findByIntygId(intygId).stream()
  ...
  @Override
  public ArendeDraft create(
      String certificateId, String subject, String message, String questionId) {
