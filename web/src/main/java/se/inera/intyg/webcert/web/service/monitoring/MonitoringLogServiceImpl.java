...
public class MonitoringLogServiceImpl implements MonitoringLogService {
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            .put(
                ...
                toEventType(MonitoringEvent.USER_MISSING_MIU_ON_ENHET))
            .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_DENIED)
            .put(MdcLogConstants.USER_ID, userHsaId)
  ...
  @Override
  public void logQuestionReceived(
    ...
    if (KOMPLETTERING_AV_LAKARINTYG == amne) {
      ...
      logEvent(
          MonitoringEvent.QUESTION_RECEIVED_COMPLETION,
          fragestallare,
          externReferens,
          internReferens,
          intygsId,
      ...
      logEvent(
          MonitoringEvent.QUESTION_RECEIVED,
          fragestallare,
          externReferens,
          internReferens,
          intygsId,
  ...
  @Override
  public void logAnswerReceived(
      String externReferens, Long internReferens, String intygsId, String enhet, Amne amne) {
    final var subject = amne != null ? amne.name() : NO_AMNE;
    logEvent(
        MonitoringEvent.ANSWER_RECEIVED, externReferens, internReferens, intygsId, enhet, subject);
  }

  @Override
  public void logQuestionSent(
      String externReferens, Long internReferens, String intygsId, String enhet, Amne amne) {
    final var subject = amne != null ? amne.name() : NO_AMNE;
    logEvent(
        MonitoringEvent.QUESTION_SENT, externReferens, internReferens, intygsId, enhet, subject);
  }

  @Override
  public void logAnswerSent(
      String externReferens, Long internReferens, String intygsId, String enhet, Amne amne) {
    final var subject = amne != null ? amne.name() : NO_AMNE;
    ...
    if (nrPrefillElements > 0) {
      try (MdcCloseableMap ignored =
          MdcCloseableMap.builder()
              ...
              .build()) {
        logEvent(
            MonitoringEvent.UTKAST_CREATED_PREFILL,
            intygsId,
            intygsTyp,
            nrPrefillElements,
            userHsaId,
  ...
  @Override
  public void logUtkastCreatedTemplateManual(
      String intygsId,
      String intygsTyp,
      String userHsaId,
      String unitHsaId,
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.UTKAST_CREATED_TEMPLATE_MANUAL,
          intygsId,
          intygsTyp,
          userHsaId,
          unitHsaId,
  ...
  @Override
  public void logUtkastCreatedTemplateAuto(
      String intygsId,
      String intygsTyp,
      String userHsaId,
      String unitHsaId,
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.UTKAST_CREATED_TEMPLATE_AUTO,
          intygsId,
          intygsTyp,
          userHsaId,
          unitHsaId,
  ...
  public void logUtkastConcurrentlyEdited(String intygsId, String intygsTyp) {
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.UTKAST_CONCURRENTLY_EDITED))
            .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_INFO)
            .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
            .put(MdcLogConstants.EVENT_CERTIFICATE_TYPE, intygsTyp)
            .build()) {
  ...
  public void logPrivatePractitionerTermsApproved(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.PP_TERMS_ACCEPTED,
          userId,
          hashUtility.hash(personId.getPersonnummer()),
          avtalVersion);
    }
  }
  ...
  public void logStatusUpdateQueued(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.STATUS_UPDATE_QUEUED,
          certificateId,
          correlationId,
          logicalAddress,
          certificateType,
    ...
    if (ArendeAmne.KOMPLT == amne) {
      ...
      try (MdcCloseableMap ignored =
          MdcCloseableMap.builder()
              .put(
                  MdcLogConstants.EVENT_ACTION,
                  toEventType(MonitoringEvent.ARENDE_RECEIVED_QUESTION))
              .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_CREATION)
              .put(MdcLogConstants.EVENT_MESSAGE_SUBJECT, subject)
              .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
              .put(MdcLogConstants.EVENT_CERTIFICATE_TYPE, intygsTyp)
    ...
    if (isAnswer) {
      ...
      try (MdcCloseableMap ignored =
          MdcCloseableMap.builder()
              .put(
                  MdcLogConstants.EVENT_ACTION,
                  toEventType(MonitoringEvent.ARENDE_CREATED_QUESTION))
              .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_CREATION)
              .put(MdcLogConstants.EVENT_MESSAGE_SUBJECT, subject)
              .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
              .put(MdcLogConstants.EVENT_CERTIFICATE_TYPE, intygsTyp)
  ...
  @Override
  public void logIntegratedOtherUnit(
      String intygsId,
      String intygsTyp,
      String certificateCareProvider,
  ...
  @Override
  public void logIntegratedOtherCaregiver(
      String intygsId,
      String intygsTyp,
      String certificateCareProvider,
      String certificateUnitId,
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.LOGIN_OTHER_CAREGIVER,
          intygsId,
          intygsTyp,
  ...
  public void logIdpConnectivityCheck(String ip, String connectivity) {
          ...
          .forEach(
              connection ->
                  connectivityResult
                      ...
                      .append(connection.connected ? " OK" : " Not OK")
                      .append("! "));
    } catch (Exception e) {
    ...
    logEvent(
        MonitoringEvent.IDP_CONNECTIVITY_CHECK,
        ip,
        careProvider,
        careUnit,
  ...
  @Override
  public void logSrsLoaded(
      String userClientContext,
      String intygsId,
      String caregiverId,
      String careUnitId,
  ...
  public void logSrsPanelActivated(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_PANEL_ACTIVATED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsConsentAnswered(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_CONSENT_ANSWERED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsQuestionAnswered(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_QUESTION_ANSWERED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsCalculateClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_CALCULATE_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsHideQuestionsClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.SRS_HIDE_QUESTIONS_CLICKED))
            .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_INFO)
            .put(MdcLogConstants.EVENT_SRS_CLIENT_CONTEXT, userClientContext)
            .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
            .put(MdcLogConstants.EVENT_CERTIFICATE_CARE_PROVIDER_ID, caregiverId)
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_HIDE_QUESTIONS_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsShowQuestionsClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.SRS_SHOW_QUESTIONS_CLICKED))
            .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_INFO)
            .put(MdcLogConstants.EVENT_SRS_CLIENT_CONTEXT, userClientContext)
            .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
            .put(MdcLogConstants.EVENT_CERTIFICATE_CARE_PROVIDER_ID, caregiverId)
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_SHOW_QUESTIONS_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsMeasuresShowMoreClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_MEASURES_SHOW_MORE_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsMeasuresExpandOneClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_MEASURES_EXPAND_ONE_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsMeasuresLinkClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.SRS_MEASURES_LINK_CLICKED))
            .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_INFO)
            .put(MdcLogConstants.EVENT_SRS_CLIENT_CONTEXT, userClientContext)
            .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
            .put(MdcLogConstants.EVENT_CERTIFICATE_CARE_PROVIDER_ID, caregiverId)
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_MEASURES_LINK_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsStatisticsActivated(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_STATISTICS_ACTIVATED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsStatisticsLinkClicked(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.SRS_STATISTICS_LINK_CLICKED))
            .put(MdcLogConstants.EVENT_TYPE, MdcLogConstants.EVENT_TYPE_INFO)
            .put(MdcLogConstants.EVENT_SRS_CLIENT_CONTEXT, userClientContext)
            .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
            .put(MdcLogConstants.EVENT_CERTIFICATE_CARE_PROVIDER_ID, caregiverId)
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_STATISTICS_LINK_CLICKED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logSrsMeasuresDisplayed(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.SRS_MEASURES_DISPLAYED,
          userClientContext,
          intygsId,
          caregiverId,
          careUnitId);
  ...
  public void logLoginAttemptMissingSubscription(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.LOGIN_ATTEMPT_MISSING_SUBSCRIPTION, userId, authMethod, organizations);
    }
  }
  ...
  @Override
  public void logMessageImported(
      String certificateId,
      String messageId,
      String caregiverId,
      String careUnitId,
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .build()) {
      logEvent(
          MonitoringEvent.MESSAGE_IMPORTED,
          messageId,
          messageType,
          certificateId,
          caregiverId,
  ...
  @Override
  public void logSignServiceErrorReceived(
    ...
    try (MdcCloseableMap ignored =
        MdcCloseableMap.builder()
            ...
            .put(MdcLogConstants.EVENT_CERTIFICATE_ID, intygsId)
            .put(
                MdcLogConstants.ERROR_MESSAGE,
                Joiner.on(" - ").useForNull("null").join(resultMajor, resultMinor, resultMessage))
            .build()) {
      logEvent(
          MonitoringEvent.DSS_SIGNATURE_RESPONSE_ERROR_RECEIVED,
          transactionId,
          intygsId,
          resultMajor,
          resultMinor,
