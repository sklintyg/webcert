...
public final class CertificateAccessServiceHelper {
  ...
  public boolean isAllowToAnswerComplementQuestion(
      AccessEvaluationParameters accessEvaluationParameters, boolean newCertificate) {
    return certificateAccessService
        .allowToAnswerComplementQuestion(accessEvaluationParameters, newCertificate)
        .isAllowed();
  }

  public void validateAccessToAnswerComplementQuestion(
      Utlatande utlatande, boolean newCertificate) {
    final AccessResult accessResult =
        evaluateAccessToAnswerComplementQuestion(utlatande, newCertificate);

    accessResultExceptionHelper.throwExceptionIfDenied(accessResult);
  }

  private AccessResult evaluateAccessToAnswerComplementQuestion(
      Utlatande utlatande, boolean newCertificate) {
  ...
  public AccessResult validateAccessToApproveReceivers(
  ...
  public boolean isAllowToPrint(
      AccessEvaluationParameters accessEvaluationParameters, boolean isEmployer) {
    return certificateAccessService
        .allowToPrint(accessEvaluationParameters, isEmployer)
        .isAllowed();
  }
  ...
  public boolean isAllowToSetComplementAsHandled(
      AccessEvaluationParameters accessEvaluationParameters) {
    return certificateAccessService
        .allowToSetComplementAsHandled(accessEvaluationParameters)
        .isAllowed();
  }
  ...
  public boolean isAllowToSetQuestionAsHandled(
      AccessEvaluationParameters accessEvaluationParameters) {
    return certificateAccessService
        .allowToSetQuestionAsHandled(accessEvaluationParameters)
        .isAllowed();
  }
  ...
  public boolean isAllowToAnswerAdminQuestion(
      AccessEvaluationParameters accessEvaluationParameters) {
    return certificateAccessService
        .allowToAnswerAdminQuestion(accessEvaluationParameters)
        .isAllowed();
  }
  ...
  public boolean isAllowToCreateDraftFromSignedTemplate(
      AccessEvaluationParameters accessEvaluationParameters) {
    return certificateAccessService
        .allowToCreateDraftFromSignedTemplate(accessEvaluationParameters)
        .isAllowed();
  }
