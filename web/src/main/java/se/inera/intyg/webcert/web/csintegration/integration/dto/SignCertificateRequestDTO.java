...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.SignCertificateRequestDTO.SignCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = SignCertificateRequestDTOBuilder.class)
@Value
@Builder
public class SignCertificateRequestDTO {
