...
public class ListCertificatesAggregator {
  ...
  public List<ListIntygEntry> listCertificatesForPatient(String patientId) {
    return csIntegrationService.listCertificatesForPatient(
        csIntegrationRequestFactory.getPatientCertificatesRequest(patientId));
  }

  public List<ListIntygEntry> listCertificatesForUnit(ListFilter filter) {
    return csIntegrationService.listCertificatesForUnit(
        csIntegrationRequestFactory.getUnitCertificatesRequest(filter));
  }
