...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.DeleteCertificateRequestDTO.DeleteCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = DeleteCertificateRequestDTOBuilder.class)
@Value
@Builder
public class DeleteCertificateRequestDTO {
    ...
    public static class DeleteCertificateRequestDTOBuilder {
