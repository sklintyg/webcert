  ...
  public boolean isValid() {
    ...
    switch (event) {
      case BROWSER_INFO:
        return info != null
            && info.get(WIDTH) != null
            && info.get(HEIGHT) != null
            && info.get(NET_ID_VERSION) != null;
      ...
      case SRS_LOADED:
        return info != null
            && info.get(INTYG_ID) != null
            && info.get(USER_CLIENT_CONTEXT) != null
            && info.get(CARE_UNIT_ID) != null
            && info.get(CAREGIVER_ID) != null
            && info.get(MAIN_DIAGNOSIS_CODE) != null;
