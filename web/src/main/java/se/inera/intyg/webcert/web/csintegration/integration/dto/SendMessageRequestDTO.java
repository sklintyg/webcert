...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.SendMessageRequestDTO.SendMessageRequestDTOBuilder;
...
@JsonDeserialize(builder = SendMessageRequestDTOBuilder.class)
@Value
@Builder
