...
import se.inera.intyg.webcert.web.csintegration.integration.dto.ValidateCertificateRequestDTO.ValidateCertificateRequestDTOBuilder;
...
@JsonDeserialize(builder = ValidateCertificateRequestDTOBuilder.class)
@Value
@Builder
public class ValidateCertificateRequestDTO {
    ...
    public static class ValidateCertificateRequestDTOBuilder {
