...
import lombok.Value;
import se.inera.intyg.webcert.web.csintegration.integration.dto.GetCertificateFromMessageRequestDTO.GetCertificteFromMessageRequestDTOBuilder;
...
@Value
@Builder
public class GetCertificateFromMessageRequestDTO {
