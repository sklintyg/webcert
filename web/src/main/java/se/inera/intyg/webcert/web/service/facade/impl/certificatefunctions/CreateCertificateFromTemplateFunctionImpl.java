...
@Component
public class CreateCertificateFromTemplateFunctionImpl
    implements CreateCertificateFromTemplateFunction {

  private static final String CREATE_AG7804_NAME = "Skapa AG7804";

  private static final String CREATE_AG7804_DESCRIPTION =
      "Skapar ett intyg till arbetsgivaren utifrån Försäkringskassans intyg.";
  private static final String CREATE_AG7804_BODY =
  ...
  private static final String CREATE_DOI_DESCRIPTION =
      "Skapar ett dödsorsaksintyg utifrån dödsbeviset.";
  private static final String CREATE_DOI_BODY =
      "Skapa ett dödsorsaksintyg utifrån ett dödsbevis innebär att informationsmängder som är "
  ...
  private static boolean notCorrectCertificateType(
