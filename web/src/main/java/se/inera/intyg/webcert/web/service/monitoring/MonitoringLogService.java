...
public interface MonitoringLogService extends AuthenticationLogger {
  ...
  void logUtkastCreated(
      String intygsId, String intygsTyp, String unitHsaId, String userHsaId, int nrPrefillElements);

  void logUtkastCreatedTemplateManual(
      String intygsId,
      String intygsTyp,
      String userHsaId,
      String unitHsaId,
  ...
  void logUtkastCreatedTemplateAuto(
      String intygsId,
      String intygsTyp,
      String userHsaId,
      String unitHsaId,
  ...
  void logPrivatePractitionerTermsApproved(
  ...
  void logIntegratedOtherCaregiver(
      String intygsId,
      String intygsTyp,
      String certificateCareProvider,
      String certificateUnitId,
  ...
  void logSrsPanelActivated(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsConsentAnswered(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsQuestionAnswered(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsCalculateClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsHideQuestionsClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsShowQuestionsClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsMeasuresShowMoreClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsMeasuresExpandOneClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsMeasuresLinkClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsStatisticsActivated(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsStatisticsLinkClicked(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);

  void logSrsMeasuresDisplayed(
      String userClientContext, String intygsId, String caregiverId, String careUnitId);
  ...
  void logSignServiceErrorReceived(
