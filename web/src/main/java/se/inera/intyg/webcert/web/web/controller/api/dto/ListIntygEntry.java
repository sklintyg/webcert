...
public class ListIntygEntry {
  ...
  @JsonIgnore private String intygTypeName;

  private String status;

  @JsonIgnore private String statusName;
  ...
  public boolean equals(Object o) {
    ...
    return vidarebefordrad == that.vidarebefordrad
        && version == that.version
        && sekretessmarkering == that.sekretessmarkering
        && avliden == that.avliden
        && isTestIntyg == that.isTestIntyg
        && Objects.equals(intygId, that.intygId)
        && Objects.equals(patientId, that.patientId)
        && source == that.source
        && Objects.equals(intygType, that.intygType)
        && Objects.equals(intygTypeVersion, that.intygTypeVersion)
        && Objects.equals(intygTypeName, that.intygTypeName)
        && Objects.equals(status, that.status)
        && Objects.equals(statusName, that.statusName)
        && Objects.equals(lastUpdatedSigned, that.lastUpdatedSigned)
        && Objects.equals(updatedSignedBy, that.updatedSignedBy)
        && Objects.equals(updatedSignedById, that.updatedSignedById)
        && Objects.equals(vardenhetId, that.vardenhetId)
        && Objects.equals(vardgivarId, that.vardgivarId)
