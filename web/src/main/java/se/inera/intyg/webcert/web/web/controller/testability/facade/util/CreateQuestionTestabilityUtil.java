...
public class CreateQuestionTestabilityUtil {
  ...
  public String createNewQuestion(
    ...
    if (shouldCreateAnswer(createQuestionRequest)) {
      final var arendeSvar =
          createArendeSvar(
              arende, createQuestionRequest.getAnswer(), draft.getSkapadAv().getNamn());
  ...
  private boolean shouldCreateAnswer(CreateQuestionRequestDTO createQuestionRequest) {
    return createQuestionRequest.getAnswer() != null
        && !createQuestionRequest.getAnswer().isBlank()
  ...
  public String createNewQuestionDraft(
      String certificateId, CreateQuestionRequestDTO createQuestionRequest) {
    final var questionDraft = new ArendeDraft();
  ...
  private Arende createArende(CreateQuestionRequestDTO createQuestionRequest, Utkast draft) {
    ...
    // TODO: When receiving a question, the skickadAv is FK. If sending a question the skickadAv is
    // WC.
