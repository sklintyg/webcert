...
public class AvailableFunctionDTO {
  ...
  public static AvailableFunctionDTO create(
      AvailableFunctionTypeDTO type,
      String title,
      String name,
      String body,
      String description,
  ...
  public static AvailableFunctionDTO create(
      AvailableFunctionTypeDTO type, String title, String name, String body, boolean enabled) {
    final var availableFunction = new AvailableFunctionDTO();
    availableFunction.setType(type);
    availableFunction.setTitle(title);
    availableFunction.setName(name);
  ...
  public static AvailableFunctionDTO create(
      AvailableFunctionTypeDTO type, String name, boolean enabled) {
    final var availableFunction = new AvailableFunctionDTO();
    availableFunction.setType(type);
    availableFunction.setName(name);
    availableFunction.setEnabled(enabled);
