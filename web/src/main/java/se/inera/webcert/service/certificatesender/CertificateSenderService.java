...
public interface CertificateSenderService {
    ...
    void sendCertificate(String intygsId, String recipientId) throws CertificateSenderException;
    void revokeCertificate(String intygsId) throws CertificateSenderException;
}
