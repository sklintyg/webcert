...
class HandleQuestionFromCertificateServiceTest {
  ...
  @InjectMocks private HandleQuestionFromCertificateService handleQuestionFromCertificateService;
  ...
  void shallReturnHandledQuestion() {
    ...
    final var certificteFromMessageRequestDTO =
        GetCertificateFromMessageRequestDTO.builder().build();

    doReturn(handleMessageRequestDTO)
        .when(csIntegrationRequestFactory)
        .handleMessageRequestDTO(false);
    doReturn(certificteFromMessageRequestDTO)
        .when(csIntegrationRequestFactory)
        .getCertificateFromMessageRequestDTO();
    doReturn(question)
        .when(csIntegrationService)
        .handleMessage(handleMessageRequestDTO, MESSAGE_ID);
    doReturn(certificate)
        .when(csIntegrationService)
        .getCertificate(certificteFromMessageRequestDTO, MESSAGE_ID);
