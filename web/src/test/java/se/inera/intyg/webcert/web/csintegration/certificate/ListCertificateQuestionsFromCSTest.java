...
class ListCertificateQuestionsFromCSTest {
  ...
  private static final GetUnitQuestionsRequestDTO GET_UNIT_QUESTIONS_REQUEST_DTO =
      GetUnitQuestionsRequestDTO.builder().build();
  private static final String HSA_ID = "hsaId";
  private static QueryFragaSvarParameter queryFragaSvarParameter;

  @InjectMocks ListCertificateQuestionsFromCS listCertificateQuestionsFromCS;
  @Mock CSIntegrationService csIntegrationService;

  @Mock CSIntegrationRequestFactory csIntegrationRequestFactory;

  @Mock QuestionStatusFilter questionStatusFilter;

  @Mock WebCertUserService webCertUserService;

  @BeforeEach
  void setUp() {
    queryFragaSvarParameter = buildQueryFragaSvarParameter(false, true, "SVAR_FRAN_VARDEN", HSA_ID);
  }
  ...
  void shouldFilterNotIncludedInStatus() {
    when(questionStatusFilter.validate(ARENDE_LIST_NOT_INCLUDED_IN_STATUS, ANSWER))
        .thenReturn(false);
    when(questionStatusFilter.validate(ARENDE_LIST_ITEM, ANSWER)).thenReturn(true);
  ...
  class FilterConverter {
    ...
    void shouldConvertSignedById() {
      ...
      assertEquals(
          queryFragaSvarParameter.getHsaId(), argumentCaptor.getValue().getIssuedByStaffId());
    }
    ...
    void shouldConvertUnitIdIfSet() {
      ...
      verify(csIntegrationRequestFactory).getUnitQuestionsRequestDTO(argumentCaptor.capture());
      assertEquals(
          queryFragaSvarParameter.getEnhetId(),
    ...
    void shouldConvertChangedFrom() {
      ...
      verify(csIntegrationRequestFactory).getUnitQuestionsRequestDTO(argumentCaptor.capture());
      assertEquals(
          queryFragaSvarParameter.getChangedFrom(), argumentCaptor.getValue().getSentDateFrom());
    }
    ...
    void shouldConvertChangedTo() {
      ...
      verify(csIntegrationRequestFactory).getUnitQuestionsRequestDTO(argumentCaptor.capture());
      assertEquals(
          queryFragaSvarParameter.getChangedTo(), argumentCaptor.getValue().getSentDateTo());
    }
    ...
    void shouldConvertForwarded() {
      ...
      verify(csIntegrationRequestFactory).getUnitQuestionsRequestDTO(argumentCaptor.capture());
      assertEquals(
          queryFragaSvarParameter.getVidarebefordrad(), argumentCaptor.getValue().getForwarded());
    }
    ...
    void shouldConvertPatientID() {
      ...
      verify(csIntegrationRequestFactory).getUnitQuestionsRequestDTO(argumentCaptor.capture());
      assertEquals(
          queryFragaSvarParameter.getPatientPersonId(),
    ...
    void shouldSetQuestionStatusTypeToComplement() {
      final var queryFragaSvarParameter =
          buildQueryFragaSvarParameter(false, true, "KOMPLETTERING_FRAN_VARDEN", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
    ...
    void shouldSetQuestionStatusTypeToHandled() {
      final var queryFragaSvarParameter =
          buildQueryFragaSvarParameter(false, true, "HANTERAD", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
      final var argumentCaptor = ArgumentCaptor.forClass(QuestionStatusType.class);
    ...
    void shouldSetQuestionStatusTypeToNotHandled() {
      final var queryFragaSvarParameter =
          buildQueryFragaSvarParameter(false, true, "ALLA_OHANTERADE", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
      final var argumentCaptor = ArgumentCaptor.forClass(QuestionStatusType.class);
    ...
    void shouldSetQuestionStatusTypeToAnswer() {
      final var queryFragaSvarParameter =
          buildQueryFragaSvarParameter(false, true, "SVAR_FRAN_VARDEN", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
      final var argumentCaptor = ArgumentCaptor.forClass(QuestionStatusType.class);
    ...
    void shouldSetQuestionStatusTypeToReadAnswer() {
      final var queryFragaSvarParameter =
          buildQueryFragaSvarParameter(false, true, "MARKERA_SOM_HANTERAD", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
      final var argumentCaptor = ArgumentCaptor.forClass(QuestionStatusType.class);
    ...
    void shouldSetQuestionStatusTypeToWait() {
      final var queryFragaSvarParameter =
          buildQueryFragaSvarParameter(false, true, "SVAR_FRAN_FK", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
      final var argumentCaptor = ArgumentCaptor.forClass(QuestionStatusType.class);
    ...
    void shouldSetQuestionStatusTypeToShowAll() {
      final var queryFragaSvarParameter = buildQueryFragaSvarParameter(false, true, "ALLA", HSA_ID);
      listCertificateQuestionsFromCS.list(queryFragaSvarParameter);
      final var argumentCaptor = ArgumentCaptor.forClass(QuestionStatusType.class);
  ...
  private QueryFragaSvarParameter buildQueryFragaSvarParameter(
      Boolean fromFK, Boolean fromWC, String vantarPa, String hsaId) {
