...
class CertificateSignAndSendFunctionImplTest {
  ...
  private static final String SIGN_AND_SEND_DESCRIPTION_ARBETSFORMEDLINGEN =
      "Intyget skickas direkt till Arbetsförmedlingen.";
  private static final String SIGN_AND_SEND_DESCRIPTION_FORSAKRINGSKASSAN =
      "Intyget skickas direkt till Försäkringskassan.";
  private static final String SIGN_AND_SEND_DESCRIPTION_SKATTEVERKET =
      "Intyget skickas direkt till Skatteverket.";
  private static final String SIGN_AND_SEND_DESCRIPTION_SOCIALSTYRELSEN =
      "Intyget skickas direkt till Socialstyrelsen.";
  private static final String SIGN_AND_SEND_DESCRIPTION_TRANSPORTSTYRELSEN =
      "Intyget skickas direkt till Transportstyrelsen.";
  ...
  @InjectMocks private CertificateSignAndSendFunctionImpl certificateSignAndSendFunction;
  ...
  class TestType {
    ...
    class HasActiveFeature {
      ...
      void setup() {
        when(authoritiesHelper.isFeatureActive(
                AuthoritiesConstants.FEATURE_SIGNERA_SKICKA_DIREKT, Af00213EntryPoint.MODULE_ID))
            .thenReturn(true);
    ...
    class IsComplementingCertificate {
      ...
      void setup() {
        ...
        when(authoritiesHelper.isFeatureActive(
                AuthoritiesConstants.FEATURE_SIGNERA_SKICKA_DIREKT, LisjpEntryPoint.MODULE_ID))
            .thenReturn(false);

        relation = CertificateRelation.builder().type(CertificateRelationType.COMPLEMENTED).build();

        certificate =
            CertificateFacadeTestHelper.createCertificateWithParentRelation(
                LisjpEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED, relation);
      }
  ...
  class TestDescription {
    ...
    private void setupFeature(String id) {
      when(authoritiesHelper.isFeatureActive(
              AuthoritiesConstants.FEATURE_SIGNERA_SKICKA_DIREKT, id))
          .thenReturn(true);
    }
    ...
    void shallIncludeFunctionWithDescriptionSkatteverketWhenCertificateTypeIsDb() {
      ...
      final var certificate =
          CertificateFacadeTestHelper.createCertificate(
              DbModuleEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
    ...
    class Forsakringskassan {
      ...
      void shallIncludeFunctionWithDescriptionForsakringskassanWhenCertificateTypeIsFk7263() {
        ...
        final var certificate =
            CertificateFacadeTestHelper.createCertificate(
                Fk7263EntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
      ...
      void shallIncludeFunctionWithDescriptionForsakringskassanWhenCertificateTypeIsLuse() {
        ...
        final var certificate =
            CertificateFacadeTestHelper.createCertificate(
                LuseEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
      ...
      void shallIncludeFunctionWithDescriptionForsakringskassanWhenCertificateTypeIsLuaefs() {
        ...
        final var certificate =
            CertificateFacadeTestHelper.createCertificate(
                LuaefsEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
      ...
      void shallIncludeFunctionWithDescriptionForsakringskassanWhenCertificateTypeIsLuaena() {
        ...
        final var certificate =
            CertificateFacadeTestHelper.createCertificate(
                LuaenaEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
    ...
    class Transportstyrelsen {
      ...
      void shallIncludeFunctionWithDescriptionTransportstyrelsenWhenCertificateTypeIsTsBas() {
        ...
        final var certificate =
            CertificateFacadeTestHelper.createCertificate(
                TsBasEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
      ...
      void shallIncludeFunctionWithDescriptionTransportstyrelsenWhenCertificateTypeIsTsDiabetes() {
        ...
        final var certificate =
            CertificateFacadeTestHelper.createCertificate(
                TsDiabetesEntryPoint.MODULE_ID, CertificateStatus.UNSIGNED);
    ...
    void shallIncludeFunctionWithNullDescriptionWhenCertificateTypeIsInvalid() {
      ...
      final var certificate =
          CertificateFacadeTestHelper.createCertificate("InvalidId", CertificateStatus.UNSIGNED);
