...
class ReplaceCertificateFacadeServiceImplTest {
    ...
    void shallIncludePatientId() {
        ...
        replaceCertificateFacadeService.replaceCertificate(CERTIFICATE_ID, CERTIFICATE_TYPE, PATIENT_ID);

        final var replaceIntygRequestArgumentCaptor = ArgumentCaptor.forClass(CopyIntygRequest.class);

        verify(copyUtkastServiceHelper).createReplacementCopyRequest(anyString(), anyString(), replaceIntygRequestArgumentCaptor.capture());
    ...
    void shallReturnNewDraftId() {
        ...
        final var actualCertificateId = replaceCertificateFacadeService.replaceCertificate(CERTIFICATE_ID, CERTIFICATE_TYPE, PATIENT_ID);
