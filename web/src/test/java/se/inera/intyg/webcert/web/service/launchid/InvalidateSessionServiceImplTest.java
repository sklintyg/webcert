...
class InvalidateSessionServiceImplTest {
  ...
  private static final String ENCODED_SESSION_ID =
      "OTdmMjc5YmEtN2QyYi00YjBhLTg2NjUtN2FkZGUwOGYyNmY0";
  @Mock private Cache redisCacheLaunchId;
  private FindByIndexNameSessionRepository<Session> sessionRepository =
      mock(FindByIndexNameSessionRepository.class, withSettings().lenient());
  @InjectMocks public InvalidateSessionServiceImpl launchIdService;
