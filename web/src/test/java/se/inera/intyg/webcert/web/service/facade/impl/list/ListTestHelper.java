...
class ListTestHelper {
  ...
  public static ListIntygEntry createListIntygEntry(
      String status, boolean includePatientStatuses, boolean forwarded) {
  ...
  public static ListIntygEntry createListIntygEntry(
      String status,
      boolean includePatientStatuses,
      boolean forwarded,
      String patientId,
      ActionLink link) {
  ...
  public static CertificateListEntry createCertificateListEntry(
      boolean isSent, boolean includePatientStatuses, String patientId) {
  ...
  public static ArendeListItem createQuestionListEntry(
      boolean includePatientStatuses, String patientId) {
