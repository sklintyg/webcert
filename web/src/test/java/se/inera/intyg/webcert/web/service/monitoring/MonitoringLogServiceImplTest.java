...
class MonitoringLogServiceImplTest {
  ...
  @Mock private MailNotification mailNotification;
  @Spy private HashUtility hashUtility;

  @Captor private ArgumentCaptor<LoggingEvent> captorLoggingEvent;

  @InjectMocks private MonitoringLogServiceImpl logService;
  ...
  void shouldLogIntygCopied() {
    ...
    verifyLog(
        Level.INFO, "INTYG_COPIED Utkast 'COPY_INTYGS_ID' created as a copy of 'ORGINAL_INTYG_ID'");
  }
  ...
  void shouldLogIntygCopiedRenewal() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_COPIED_RENEWAL Utkast 'COPY_INTYGS_ID' created as a renewal copy of 'ORGINAL_INTYG_ID'");
  }
  ...
  void shouldLogIntygCopiedReplacement() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_COPIED_REPLACEMENT Utkast 'COPY_INTYGS_ID' created as a replacement copy of 'ORGINAL_INTYG_ID'");
  }
  ...
  void shouldLogIntygCopiedCompletion() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_COPIED_COMPLETION Utkast 'COPY_INTYGS_ID' created as a completion copy of 'ORGINAL_INTYG_ID'");
  }
  ...
  void shouldLogIntygPrintPdfMinimal() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_PRINT_PDF Intyg 'INTYGS_ID' of type 'INTYGS_TYP' was printed as PDF with 'MINIMAL' content");
  }
  ...
  void shouldLogIntygPrintPdfComplete() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_PRINT_PDF Intyg 'INTYGS_ID' of type 'INTYGS_TYP' was printed as PDF with 'FULL' content");
  }
  ...
  void shouldLogIntygRegistered() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_REGISTERED Intyg 'INTYGS_ID' of type 'INTYGS_TYP' registered with Intygstjänsten");
  }
  ...
  void shouldLogIntygRevoked() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_REVOKED Intyg 'INTYGS_ID' of type 'INTYGS_TYP' revoked by 'HSA_ID' reason 'REASON'");
  }
  ...
  void shouldLogIntygSent() {
    ...
    verifyLog(
        Level.INFO,
        "INTYG_SENT Intyg 'INTYGS_ID' of type 'INTYGS_TYP' sent to recipient 'RECIPIENT'");
  }
  ...
  void shouldLogMailMissingAddress() {
    ...
    verifyLog(
        Level.INFO,
        "MAIL_MISSING_ADDRESS Mail sent to admin on behalf of unit 'HSA_ID' for REASON");
  }
  ...
  void shouldLogMissingMedarbetarUppdragWithEnhet() {
    ...
    verifyLog(
        Level.INFO,
        "USER_MISSING_MIU_ON_ENHET No valid MIU was found for user 'HSA_ID' on unit 'ENHET'");
  }
  ...
  void shouldLogNotificationSent() {
    ...
    verifyLog(
        Level.INFO,
        "NOTIFICATION_SENT Sent notification of type 'HAN_TYPE' to unit 'ENHET' for 'INTYGS_ID'");
  }

  @Test
  void shouldLogArendeReceived() {
    logService.logArendeReceived(
        INTYGS_ID, INTYGS_TYP, ENHET, ArendeAmne.KONTKT, null, false, MESSAGE_ID);
    verifyLog(
        Level.INFO,
  ...
  void shouldLogArendeReceivedWithAllParametersNull() {
    ...
    verifyLog(
        Level.INFO,
        "ARENDE_RECEIVED_QUESTION Received arende with amne 'NO AMNE' for 'null' of type 'null' for unit 'null'");
  }
  ...
  void shouldLogArendeReceivedAnswer() {
    logService.logArendeReceived(
        INTYGS_ID, INTYGS_TYP, ENHET, ArendeAmne.KONTKT, null, true, MESSAGE_ID);
    verifyLog(
        Level.INFO,
  ...
  void shouldLogArendeCreatedWithAllParametersNull() {
    ...
    verifyLog(
        Level.INFO,
        "ARENDE_CREATED_QUESTION Created arende with amne 'NO AMNE' for 'null' of type 'null' for unit 'null'");
  }
  ...
  void shouldLogArendeCreatedAnswerWithAllParametersNull() {
    ...
    verifyLog(
        Level.INFO,
        "ARENDE_CREATED_ANSWER Created arende with amne 'NO AMNE' for 'null' of type 'null' for unit 'null'");
  }
  ...
  void shouldLogQuestionReceived() {
    logService.logQuestionReceived(
        FRAGESTALLARE, INTYGS_ID, EXTERN_REFERENS, INTERN_REFERENS, ENHET, AMNE, null);
    verifyLog(
        Level.INFO,
  ...
  void shouldLogUserLogin() {
    logService.logUserLogin(
        HSA_ID, USER_ROLE, USER_ROLE_TYPE_NAME, AUTH_SCHEME, UserOriginType.NORMAL.name());
    verifyLog(
        Level.INFO,
  ...
  void shouldLogUserSessionExpired() {
    ...
    verifyLog(
        Level.INFO,
        "USER_SESSION_EXPIRY Session expired for user 'HSA_ID' using scheme 'AUTH_SCHEME'");
  }
  ...
  void shouldLogUtkastDisposed() {
    logService.logUtkastDisposed(
        INTYGS_ID,
        INTYGS_TYP,
        ChronoUnit.DAYS.between(LocalDate.now(), LocalDate.now().plusDays(5)));
    verifyLog(
        Level.INFO,
        "UTKAST_DISPOSED Utkast 'INTYGS_ID' of type 'INTYGS_TYP' was disposed due to being older than '5' days");
  }
  ...
  void shouldLogIntegratedOtherUnit() {
    logService.logIntegratedOtherUnit(
        INTYGS_ID, INTYGS_TYP, VARDGIVARE, ENHET, CARE_PROVIDER, UNIT);
    verifyLog(
        Level.INFO,
        "LOGIN_OTHER_UNIT Viewed intyg 'INTYGS_ID' of type 'INTYGS_TYP' on other unit 'ENHET'");
  }

  @Test
  void shouldLogIntegratedOtherCaregiver() {
    logService.logIntegratedOtherCaregiver(
        INTYGS_ID, INTYGS_TYP, VARDGIVARE, ENHET, CARE_PROVIDER, UNIT);
    verifyLog(
        Level.INFO,
  ...
  void shouldLogBrowserInfo() {
    logService.logBrowserInfo(
        "BROWSERNAME", "VERSION", "OS", "OS-VERSION", "WIDTH", "HEIGHT", "NETIDVERSION");
    verifyLog(
        Level.INFO,
  ...
  void shouldLogUtkastPatientDetailsUpdated() {
    ...
    verifyLog(
        Level.INFO,
        "UTKAST_PATIENT_UPDATED Patient details for utkast 'INTYGS_ID' of type 'INTYGS_TYP' updated");
  }
  ...
  void shouldLogDiagnoskodverkChanged() {
    ...
    verifyLog(
        Level.INFO,
        "DIAGNOSKODVERK_CHANGED Diagnoskodverk changed for utkast 'INTYGS_ID' of type 'INTYGS_TYP'");
  }
  ...
  void shouldLogMessageImported() {
    logService.logMessageImported(
        "CertificateId", "MessageId", "CareGiverId", "CareUnitId", "MessageType");
    verifyLog(
        Level.INFO,
