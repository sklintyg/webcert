...
class CustomAuthenticationSuccessHandlerTest {
  ...
  @Mock private DefaultSavedRequest savedRequest;
  ...
  @Captor
  private ArgumentCaptor<IntegrationParameters> captor =
      ArgumentCaptor.forClass(IntegrationParameters.class);

  @InjectMocks private CustomAuthenticationSuccessHandler successHandler;
    ...
    void shouldReplaceHostAndStripPortFromAbsoluteRedirectUrl()
      ...
      verify(redirectStrategy, times(ONE))
          .sendRedirect(
              ...
              resp,
              "http://"
                  + WEBCERT_DOMAIN_NAME_VALUE
                  + "/visa/intyg/1ff83a34-1f90-4859-90db-2a1ec65dd741");
    }
  }
