...
public class SendMessageToRecipientTypeBuilderTest {
  ...
  public void buildTest() {
    ...
    assertEquals(
        ARBETSPLATSKOD, result.getSkickatAv().getEnhet().getArbetsplatskod().getExtension());
    ...
    assertEquals(
        VARDGIVARE_ID,
        result.getSkickatAv().getEnhet().getVardgivare().getVardgivareId().getExtension());
    assertNotNull(result.getSkickatAv().getEnhet().getVardgivare().getVardgivareId().getRoot());
    assertEquals(
        VARDGIVARE_NAMN, result.getSkickatAv().getEnhet().getVardgivare().getVardgivarnamn());
  }
