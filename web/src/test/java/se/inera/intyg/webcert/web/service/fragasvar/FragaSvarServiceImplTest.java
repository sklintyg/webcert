...
public class FragaSvarServiceImplTest extends AuthoritiesConfigurationTestSetup {
    ...
    public void testGetFragaSvarForIntyg() {
        ...
        List<FragaSvar> result = service.getFragaSvar("intyg-1").stream()
    ...
    private IntygContentHolder getIntygContentHolder() {
        ...
        return new IntygContentHolder("<external-json/>", getUtlatande(), status, false, null, false);
    }
    ...
    private IntygContentHolder getRevokedIntygContentHolder() {
        ...
        return new IntygContentHolder("<external-json/>", getUtlatande(), status, true, null, false);
    }
    ...
    public void testGetNbrOfUnhandledFragaSvarForCareUnits() {
        ...
        when(fragasvarRepositoryMock.countUnhandledGroupedByEnhetIdsAndIntygstyper(Mockito.anyListOf(String.class), Mockito.anySetOf(String.class)))
