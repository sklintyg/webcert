...
class TextVersionFacadeServiceImplTest {
    ...
    @InjectMocks
    private TextVersionFacadeServiceImpl textVersionFacadeService;
    ...
    public void shouldNotUpdateIfAlreadyLatestVersion() throws IOException, ModuleException {
        ...
        final var actual = textVersionFacadeService.assertLatestTextVersionForDraft(input);
    ...
    public void shouldThrowWebcertServiceExceptionIfOptimisticLockOnSave() throws IOException, ModuleException {
        ...
        final var input = createUtkast(PREVIOUS_VERSION, PREVIOUS_VERSION, UtkastStatus.DRAFT_INCOMPLETE);
        final var e = assertThrows(WebCertServiceException.class, () -> textVersionFacadeService.assertLatestTextVersionForDraft(input));
    ...
    private void assertTextVersionAndStatus(Utkast expected, Utkast actual) {
        ...
        assertEquals(expected.getIntygTypeVersion(), actual.getIntygTypeVersion());
