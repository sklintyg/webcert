...
public abstract class AccessServiceTestToolkit {
  ...
  public static WebCertUser createUser(
      String intygsTyp, AccessServiceTestData accessServiceTestData) {
    return createUserWithoutParameters(
        intygsTyp,
  ...
  public static WebCertUser createUserDifferentUnit(
      String intygsTyp, AccessServiceTestData accessServiceTestData) {
    return createUserWithoutParameters(
        intygsTyp,
        getFeatureMap(intygsTyp, accessServiceTestData.getFeatures()),
  ...
  public static WebCertUser createUser(
      String intygsTyp, AccessServiceTestData accessServiceTestData, boolean inactiveUnit) {
    return createUser(intygsTyp, accessServiceTestData, inactiveUnit, true);
  }

  public static WebCertUser createUser(
      String intygsTyp,
      AccessServiceTestData accessServiceTestData,
  ...
  public static WebCertUser createUser(
    ...
    return createUserWithParameters(
        intygsTyp,
        getFeatureMap(intygsTyp, accessServiceTestData.getFeatures()),
        getPrivilegesMap(intygsTyp, accessServiceTestData.getPrivileges()),
        inactiveUnit,
  ...
  private static WebCertUser createUserWithParameters(
      String intygsTyp,
    ...
    if (differentUnit) {
      doReturn(Arrays.asList(new String[] {"AnnatEnhetsId"}))
          .when(webCertUser)
          .getIdsOfSelectedVardenhet();
    } else {
      doReturn(Arrays.asList(new String[] {"EnhetsId"}))
          .when(webCertUser)
          .getIdsOfSelectedVardenhet();
    }
  ...
  private static WebCertUser createUserWithoutParameters(
      String intygsTyp,
      Map<String, Feature> featureMap,
      Map<String, Privilege> privilegesMap,
      boolean differentUnit) {
  ...
  private static Map<String, Privilege> getUtkastAuthority(String intygsTyp) {
    return getPrivilegesMap(
        createPrivilege(
            ...
            Lists.newArrayList(
                createRequestOrigin(UserOriginType.NORMAL.name(), Arrays.asList(intygsTyp)))));
  }
  ...
  private static IntegrationParameters getParameters(boolean inactiveUnit, boolean fornyaOk) {
    return new IntegrationParameters(
        "", "", "", "", "", "", "", "", "", false, false, inactiveUnit, fornyaOk, null);
  }
  ...
  private static Map<String, Privilege> getPrivilegesMap(
      String intygsTyp, List<String> privileges) {
    final HashMap<String, Privilege> privilegesHashMap = new HashMap<>();
    for (String privilege : privileges) {
      privilegesHashMap.put(
          privilege,
          createPrivilege(
              privilege,
              Collections.emptyList(),
  ...
  private static WebCertUser createUser(
  ...
  public static Map<String, Map<String, PreviousIntyg>> createEmptyPreviousForUtkast(
      String intygsTyp) {
  ...
  public static Map<String, Map<String, PreviousIntyg>> createPreviousUtkastForUtkast(
      String intygsTyp) {
  ...
  public static Map<String, Map<String, PreviousIntyg>> createPreviousIntygForUtkast(
      String intygsTyp, boolean checkVardgivare) {
    final PreviousIntyg previousIntyg = mock(PreviousIntyg.class);
