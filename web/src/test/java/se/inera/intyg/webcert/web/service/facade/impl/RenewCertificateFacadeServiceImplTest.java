...
class RenewCertificateFacadeServiceImplTest {
  ...
  @InjectMocks private RenewCertificateFacadeServiceImpl renewCertificateFacadeService;

  private static final String CERTIFICATE_ID = "certificateId";
  private static final String RENEW_CERTIFICATE_ID = "renewCertificateId";
  ...
  class RenewCertificate {
    ...
    void shallIncludeCertificateId() {
      ...
      verify(copyUtkastServiceHelper)
          .createRenewalCopyRequest(
              certificateIdArgumentCaptor.capture(), anyString(), any(CopyIntygRequest.class));
    ...
    void shallIncludeCertificateType() {
      ...
      verify(copyUtkastServiceHelper)
          .createRenewalCopyRequest(
              anyString(), certificateTypeArgumentCaptor.capture(), any(CopyIntygRequest.class));
    ...
    void shallIncludePatientId() {
      ...
      verify(copyUtkastServiceHelper)
          .createRenewalCopyRequest(
              anyString(), anyString(), renewIntygRequestArgumentCaptor.capture());
  ...
  private Certificate setup() {
    ...
    final var serviceRequest =
        new CreateRenewalCopyRequest(CERTIFICATE_ID, CERTIFICATE_TYPE, null, null);
    ...
    final var serviceResponse =
        new CreateRenewalCopyResponse(
            CERTIFICATE_TYPE, "1.0", RENEW_CERTIFICATE_ID, CERTIFICATE_ID);

    doReturn(serviceResponse).when(copyUtkastService).createRenewalCopy(serviceRequest);
  ...
  private Certificate createCertificate() {
    ...
    certificate.setMetadata(
        CertificateMetadata.builder()
            ...
            .patient(
                Patient.builder()
                    .personId(PersonId.builder().id(PATIENT_ID).type("PERSON_NUMMER").build())
                    .build())
            .build());
    return certificate;
  }
