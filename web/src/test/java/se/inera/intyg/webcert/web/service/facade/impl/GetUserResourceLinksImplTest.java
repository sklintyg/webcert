...
import static se.inera.intyg.webcert.integration.privatepractitioner.dto.PrivatePractitionerValidationResultCode.OK;
...
class GetUserResourceLinksImplTest {
  ...
  @InjectMocks private GetUserResourceLinksImpl getUserResourceLinks;
  ...
  class ResourceLinks {
    ...
    void shallIncludeCreateCertificateIfOriginIsNormal() {
      final var user = getUserWithOrigin("NORMAL");
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_SEARCH_CREATE_PAGE);
    }
    ...
    void shallNotIncludeCreateCertificateIfOriginIsDjupintegration() {
      final var user = getUserWithOrigin("DJUPINTEGRATION");
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertExclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_SEARCH_CREATE_PAGE);
    }
    ...
    void shallIncludeDraftListIfOriginIsNormal() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_DRAFT_LIST);
    }
    ...
    void shallIncludeQuestionListIfOriginIsNormal() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_QUESTION_LIST);
    }
    ...
    void shallIncludeSignedCertificatesListIfOriginIsNormal() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_SIGNED_CERTIFICATES_LIST);
    }
    ...
    class ChooseUnit {
      ...
      void shallNotIncludeChooseUnitIfOriginIsNormalAndHasLoggedInUnit() {
        ...
        doReturn(getUnit()).when(user).getValdVardenhet();
    ...
    class ChangeUnit {
      ...
      void shallIncludeChangeUnitIfOriginIsNormal() {
        final var user =
            getUserWithOriginAndUnits(
                "NORMAL", List.of(new Vardgivare("id", "namn"), new Vardgivare("id2", "namn")));
        final var actualLinks = getUserResourceLinks.get(user);
      ...
      void shallIncludeChangeUnitIfOriginIsUthopp() {
        final var user =
            getUserWithOriginAndUnits(
                "UTHOPP", List.of(new Vardgivare("id", "namn"), new Vardgivare("id2", "namn")));
        final var actualLinks = getUserResourceLinks.get(user);
        ResourceLinkFacadeTestHelper.assertInclude(actualLinks, ResourceLinkTypeDTO.CHANGE_UNIT);
      }
    ...
    void shallIncludeNavigateBackButtonIfUserHasNormalOrigin() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.NAVIGATE_BACK_BUTTON);
    }
    ...
    void shallNotIncludeWarningNormalOriginIfUserHasIntegrationOrigin() {
      ...
      ResourceLinkFacadeTestHelper.assertExclude(
          actualLinks, ResourceLinkTypeDTO.WARNING_NORMAL_ORIGIN);
    }
    ...
    class SubscriptionWarning {
      ...
      WebCertUser setupUser(
          UserOriginType userOriginType,
          String loggedInCareProvider,
          List<String> missingSubscriptions,
          List<String> subscriptionWarning) {
      ...
      void shallIncludeSubscriptionWarningIfUsersLoggedInCareProviderIsMissingSubscription() {
        ...
        final var actualLinks = getUserResourceLinks.get(user);
        ResourceLinkFacadeTestHelper.assertInclude(
            actualLinks, ResourceLinkTypeDTO.SUBSCRIPTION_WARNING);
      }

      @Test
      void
          shallNotIncludeSubscriptionWarningIfUsersLoggedInCareProviderIsMissingSubscriptionButHasBeenDisplayed() {
        final var user =
            setupUser(
                UserOriginType.NORMAL,
                CARE_PROVIDER,
      ...
      @Test
      void
          shallNotIncludeSubscriptionWarningIfUsersLoggedInCareProviderIsMissingSubscriptionWhenDjupintegration() {
        final var user =
            setupUser(
  ...
  class NotAuthorizedPrivatePractitioner {
    ...
    void shallIncludeLogout() {
      ...
      when(privatePractitionerIntegrationService.validatePrivatePractitioner(
    ...
    void shallIncludeRegisterPrivatePractitioner() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_REGISTER_PRIVATE_PRACTITIONER);
    }
    ...
    void shallIncludeEditPrivatePractitionerIfNotAuthorized() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.ACCESS_EDIT_PRIVATE_PRACTITIONER);
    }
    ...
    void shallIncludeNotAuthorizedPrivatePractitionerIfNotAuthorized() {
      ...
      final var actualLinks = getUserResourceLinks.get(user);
      ResourceLinkFacadeTestHelper.assertInclude(
          actualLinks, ResourceLinkTypeDTO.NOT_AUTHORIZED_PRIVATE_PRACTITIONER);
    }
  ...
  WebCertUser getUserWithOriginAndRole(String origin, boolean isDoctor) {
    ...
    when(user.getRoles())
        .thenReturn(
            isDoctor
                ? Map.of(AuthoritiesConstants.ROLE_LAKARE, new Role())
                : Map.of(AuthoritiesConstants.ROLE_ADMIN, new Role()));
    return user;
  }
