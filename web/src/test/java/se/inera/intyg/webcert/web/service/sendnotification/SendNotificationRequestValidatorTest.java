...
class SendNotificationRequestValidatorTest {
  ...
  @InjectMocks private SendNotificationRequestValidator sendNotificationRequestValidator;
  ...
  class ValidateId {
    ...
    void shouldThrowExceptionIfIdIsEmpty() {
      assertThrows(
          IllegalArgumentException.class, () -> sendNotificationRequestValidator.validateId(""));
    }

    @Test
    void shouldThrowExceptionIfIdIsNull() {
      assertThrows(
          IllegalArgumentException.class, () -> sendNotificationRequestValidator.validateId(null));
    }
  ...
  class ValidateIds {
    ...
    void shouldThrowExceptionIfIdIsEmpty() {
      ...
      assertThrows(
          IllegalArgumentException.class, () -> sendNotificationRequestValidator.validateIds(ids));
    }

    @Test
    void shouldThrowExceptionIfIdIsNull() {
      assertThrows(
          IllegalArgumentException.class, () -> sendNotificationRequestValidator.validateIds(null));
    }
  ...
  class ValidateDateWithIntervalLimit {
    ...
    void shouldThrowExceptionIfStartDateIsBeforeLimit() {
      ...
      assertThrows(
          IllegalArgumentException.class,
          () -> sendNotificationRequestValidator.validateDate(start, end, limit));
    }
  ...
  class ValidateCertificateIds {
    ...
    void shouldThrowExceptionIfIdsAreEmpty() {
      ...
      assertThrows(
          IllegalArgumentException.class,
          () -> sendNotificationRequestValidator.validateCertificateIds(ids));
    }
    ...
    void shouldThrowExceptionIfIdsAreNull() {
      assertThrows(
          IllegalArgumentException.class,
          () -> sendNotificationRequestValidator.validateCertificateIds(null));
    }
    ...
    void shouldThrowExceptionIfIdIsEmpty() {
      final var ids =
          List.of(
              "", "941dd794-9cba-4cb8-95e6-ac7da48c07c7", "9565ca3c-qd09-4fz3-8fyf-e5043959dfe5");
      assertThrows(
          IllegalArgumentException.class,
          () -> sendNotificationRequestValidator.validateCertificateIds(ids));
    }
