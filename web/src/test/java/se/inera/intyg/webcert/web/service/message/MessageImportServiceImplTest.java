...
public class MessageImportServiceImplTest {
  ...
  @Mock private IntygService certificateService;

  @Mock private ArendeRepository messageRepository;

  @Mock private MonitoringLogService monitoringLogService;

  @InjectMocks private MessageImportServiceImpl messageImportService;
  ...
  private static String ANSWER_TO_CARE_CONTENT =
      "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><ns2:SendMessageToCare xmlns:ns6=\"urn:riv:clinicalprocess:healthcond:certificate:3.4\" xmlns:ns5=\"urn:riv:clinicalprocess:healthcond:certificate:3.2\" xmlns:ns2=\"urn:riv:clinicalprocess:healthcond:certificate:SendMessageToCareResponder:2\" xmlns:ns4=\"urn:riv:clinicalprocess:healthcond:certificate:3\" xmlns:ds=\"http://www.w3.org/2000/09/xmldsig#\" xmlns:ns3=\"urn:riv:clinicalprocess:healthcond:certificate:types:3\"><ns2:meddelande-id>Messs15</ns2:meddelande-id><ns2:referens-id>referens</ns2:referens-id><ns2:skickatTidpunkt>2019-07-13T17:23:00</ns2:skickatTidpunkt><ns2:intygs-id><ns3:root></ns3:root><ns3:extension>28a02dae-0d16-4745-8ecf-4cea05cd637d</ns3:extension></ns2:intygs-id><ns2:patientPerson-id><ns3:root>1.2.752.129.2.1.3.1</ns3:root><ns3:extension>191212121212</ns3:extension></ns2:patientPerson-id><ns2:logiskAdressMottagare>TSTNMT2321000156-1077</ns2:logiskAdressMottagare><ns2:amne><ns3:code>KONTKT</ns3:code><ns3:codeSystem>ffa59d8f-8d7e-46ae-ac9e-31804e8e8499</ns3:codeSystem><ns3:displayName>Kontakt</ns3:displayName></ns2:amne><ns2:rubrik>Svar från FK</ns2:rubrik><ns2:meddelande>Det ordnar vi vettu! Har hängt med MC-gäng vettu!</ns2:meddelande><ns2:svarPa><ns4:meddelande-id>6952fb62-fcb7-4b47-88cc-a57b9231776a</ns4:meddelande-id><ns4:referens-id></ns4:referens-id></ns2:svarPa><ns2:skickatAv><ns2:part><ns3:code>FKASSA</ns3:code><ns3:codeSystem>769bb12b-bd9f-4203-a5cd-fd14f2eb3b80</ns3:codeSystem><ns3:displayName>TRANSP</ns3:displayName></ns2:part><ns2:kontaktInfo>Nordic Medtest AB</ns2:kontaktInfo></ns2:skickatAv></ns2:SendMessageToCare>";
  private static LocalDateTime ANSWER_TO_CARE_TIMESTAMP =
      LocalDateTime.parse("2019-07-13T17:23:00");
  ...
  private static LocalDateTime ANSWER_TO_RECIPIENT_TIMESTAMP =
      LocalDateTime.parse("2020-06-10T14:16:58");
  ...
  private static LocalDateTime COMPLEMENT_TO_CARE_TIMESTAMP =
      LocalDateTime.parse("2020-05-14T12:23:00");
  ...
  private static LocalDateTime REMINDER_TO_CARE_TIMESTAMP =
  ...
  public void testImportMessagesNoMessagesInIT() {
    ...
    doReturn(Collections.emptyList())
        ...
        .findMessagesByCertificateId(certificateId);
  ...
  public void testImportMessagesNoMessageAfterExclude() {
    ...
    final var messageFromIT =
        MessageFromIT.create(
            certificateId, messageId, messageContent, subject, logicalAddress, timestamp);

    doReturn(Arrays.asList(messageFromIT))
        .when(itIntegrationService)
        .findMessagesByCertificateId(certificateId);
  ...
  public void testImportMessagesNoMessagesNotImported() {
    ...
    doReturn(Arrays.asList(messageFromIT))
        .when(itIntegrationService)
        .findMessagesByCertificateId(certificateId);
    doReturn(Arrays.asList(messageId))
        .when(messageRepository)
        .findMeddelandeIdByMeddelandeId(anyList());
  ...
  public void testImportMessagesSendQuestionToRecipient() {
    ...
    verify(monitoringLogService, times(1))
        .logMessageImported(
            CERTIFICATE_ID,
            QUESTION_TO_RECIPIENT_MESSAGE_ID,
            CARE_PROVIDER_ID,
            CARE_UNIT_ID,
  ...
  public void testImportMessagesSendAnswerToCare() {
    ...
    doReturn(certificateHolder)
        ...
        .fetchIntygDataForInternalUse(CERTIFICATE_ID, true);
    doAnswer(returnsFirstArg()).when(messageRepository).save(any());
    doReturn(questionBeingAnswered)
        .when(messageRepository)
        .findOneByMeddelandeId(QUESTION_TO_RECIPIENT_MESSAGE_ID);
    ...
    verify(monitoringLogService, times(1))
        .logMessageImported(
            CERTIFICATE_ID,
            ANSWER_TO_CARE_MESSAGE_ID,
            CARE_PROVIDER_ID,
            CARE_UNIT_ID,
            "SendMessageToCare - Answer");
  }
  ...
  public void testImportMessagesSendAnswerToRecipient() {
    ...
    doReturn(questionBeingAnswered)
        .when(messageRepository)
        .findOneByMeddelandeId(QUESTION_TO_CARE_MESSAGE_ID);
    ...
    verify(monitoringLogService, times(1))
        .logMessageImported(
            CERTIFICATE_ID,
            ANSWER_TO_RECIPIENT_MESSAGE_ID,
            CARE_PROVIDER_ID,
            CARE_UNIT_ID,
            "SendMessageToRecipient - Answer");
  }
  ...
  public void testImportMessagesSendReminderToCare() {
    ...
    doReturn(certificateHolder)
        ...
        .fetchIntygDataForInternalUse(CERTIFICATE_ID, true);
    doAnswer(returnsFirstArg()).when(messageRepository).save(any());
    doReturn(questionBeingReminded)
        .when(messageRepository)
        .findOneByMeddelandeId(QUESTION_TO_CARE_MESSAGE_ID);
