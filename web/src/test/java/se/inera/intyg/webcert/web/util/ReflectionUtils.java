...
public final class ReflectionUtils {
  ...
  public static void setStaticAttribute(Class<?> clazz, String attribute, Object newValue)
      throws Exception {
  ...
  public static void setStaticFinalAttribute(Class<?> clazz, String attribute, Object newValue)
      throws Exception {
    Field field = clazz.getDeclaredField(attribute);
    field.setAccessible(true);
