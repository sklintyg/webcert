...
public class IntygRelationHelperImplTest {
  ...
  public void testGetRelationsForIntygNothingInITWithMergeFromWebcert() {
    ...
    Relations relationsForIntyg = testee.getRelationsForIntyg(INTYG_ID);
    assertNotNull(relationsForIntyg);
    assertFrontendRelations(
        relationsForIntyg.getLatestChildRelations(),
  ...
  public void testGetRelationsForIntygOneInIT() {
    ...
    assertFrontendRelationsIntygsIds(
        relationsForIntyg.getLatestChildRelations(), null, null, OTHER_INTYG_ID, null);
  }
  ...
  public void testGetRelationsForIntygOneInITAndThreeFromWebcertIncludingParent() {
    when(listRelationsForCertificateResponderInterface.listRelationsForCertificate(
            isNull(), any(ListRelationsForCertificateType.class)))
        .thenReturn(buildResponse());
    when(certificateRelationService.getRelations(INTYG_ID))
        .thenReturn(buildWebcertRelationsWithParent());
  ...
  public void testDecorate() {
    ...
    assertFrontendRelationsIntygsIds(
        lie.getRelations().getLatestChildRelations(),
        OTHER_INTYG_ID_3,
        null,
        OTHER_INTYG_ID,
        OTHER_INTYG_ID_2);
  ...
  public void testErsattandeRevoked() {
    ...
    assertNotNull(relationsForIntyg);
    assertFrontendRelationsIntygsIds(
        relationsForIntyg.getLatestChildRelations(), null, null, null, null);
  }
  ...
  private void assertFrontendRelations(
      Relations.FrontendRelations fr,
  ...
  private void assertFrontendRelationsIntygsIds(
      Relations.FrontendRelations fr,
      String complementedByIntygIntygsId,
      String complementedByUtkastIntygsId,
      String replacedByIntygIntygsId,
      String replacedByUtkastIntygsId) {
