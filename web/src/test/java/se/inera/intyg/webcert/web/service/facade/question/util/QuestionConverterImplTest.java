...
class QuestionConverterImplTest {
  ...
  class ReceivedComplementQuestions {
    ...
    void shallReturnQuestionWithComplementThatHasAnswer() {
      final var actualQuestion =
          questionConverter.convert(
              arende, expectedComplements, null, new Arende(), Collections.emptyList());
    ...
    void shallReturnQuestionWithComplementThatHasAnswerDraft() {
      final var actualQuestion =
          questionConverter.convert(
              arende, expectedComplements, null, new ArendeDraft(), Collections.emptyList());
  ...
  class AnswerOnReceivedAdministativeQuestions {
    ...
    void shallNotThrowErrorIfContactInfoIsNull() {
      ...
      assertDoesNotThrow(
          () ->
              questionConverter.convert(
                  answer, new Complement[0], null, arendeSvar, Collections.emptyList()));
    }
    ...
    void shallReturnAnswerWithId() {
      final var actualQuestion =
          questionConverter.convert(
              arende, new Complement[0], null, arendeSvar, Collections.emptyList());
    ...
    void shallReturnQuestionWithoutAnswerIfAnswerIsNull() {
      final var actualQuestion =
          questionConverter.convert(
              arende, new Complement[0], null, (Arende) null, Collections.emptyList());
    ...
    void shallReturnAnswerDraftWithMessage() {
      final var actualQuestion =
          questionConverter.convert(
              arende, new Complement[0], null, arendeSvarDraft, Collections.emptyList());
    ...
    void shallReturnQuestionWithoutAnswerIfAnswerDraftIsNull() {
      final var actualQuestion =
          questionConverter.convert(
              arende, new Complement[0], null, (ArendeDraft) null, Collections.emptyList());
    ...
    void shallReturnReminderWithId() {
      final var actualQuestion =
          questionConverter.convert(
              ...
              null,
              arendeSvar,
              Collections.singletonList(arendePaminnelse));
    ...
    void shallReturnQuestionWithLatestLastDateToReplyFromReminderIfMultipleReminders() {
      ...
      final var actualQuestion =
          questionConverter.convert(
              ...
              null,
              arendeSvar,
              List.of(reminder1, reminder2, reminder3));
