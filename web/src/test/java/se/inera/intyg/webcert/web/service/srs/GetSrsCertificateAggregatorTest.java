...
class GetSrsCertificateAggregatorTest {
  ...
  @Mock private GetSrsCertificate getSrsCertificateFromWC;
  @Mock private GetSrsCertificate getSrsCertificateFromCS;

  private GetSrsCertificateAggregator getSrsCertificateAggregator;

  @BeforeEach
  void setUp() {
    getSrsCertificateAggregator =
        new GetSrsCertificateAggregator(
            csIntegrationService, getSrsCertificateFromWC, getSrsCertificateFromCS);
  }
