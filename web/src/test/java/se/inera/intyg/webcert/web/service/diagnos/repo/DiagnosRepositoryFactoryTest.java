...
class DiagnosRepositoryFactoryTest {
  ...
  private static final String REALLY_MESSY_LINE =
      "  A050   Matförgiftning orsakad av stafylokocker  ";
  private static final String LINE_WITH_BOM =
      "\uFEFFA050   Matförgiftning orsakad av stafylokocker  ";
  ...
  void testCreateRepository() {
    ...
    DiagnosRepositoryImpl repository =
  ...
  void testReadDiagnosFile() throws Exception {
    ...
    factory.populateRepoFromDiagnosisCodeFile(
        FILE_3, diagnosRepository, StandardCharsets.ISO_8859_1);
