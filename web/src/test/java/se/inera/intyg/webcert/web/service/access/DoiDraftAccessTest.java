...
class DoiDraftAccessTest extends DraftAccessTest {

  public DoiDraftAccessTest() {
  ...
  @Override
  protected void assertAllowToCreateUtkastOnSameCareProviderWhenUtkastSameVGExists(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.UNIQUE_DRAFT, actualValue.getCode());
  }

  @Override
  protected void assertAllowToCreateUtkastOnDifferentCareProviderWhenIntygSameVGExists(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.UNIQUE_CERTIFICATE, actualValue.getCode());
  }

  @Override
  protected void assertAllowToCreateUtkastOnSameCareProviderWhenIntygExists(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.NO_PROBLEM, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToReadUtkastOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToEditUtkastOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSignUtkastOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSignWithConfirmationWhenMissingSubscription(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.MISSING_SUBSCRIPTION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSignWithConfirmationOnSekretessPatientOnSameUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSignWithConfirmationOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSignWithConfirmationOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.DECEASED_PATIENT, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSignWithConfirmationOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.INACTIVE_UNIT, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSignWithConfirmationOnRenewFalseOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.RENEW_FALSE, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSignWithConfirmationNoConditionsDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_DIFFERENT_UNIT, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToDeleteUtkastOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }

  @Override
  protected void assertAllowToDeleteUtkastOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.NO_PROBLEM, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToPrintUtkastOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }

  @Override
  protected void assertAllowToPrintUtkastOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.NO_PROBLEM, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToForwardUtkastOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }

  @Override
  protected void assertAllowToForwardUtkastOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.DECEASED_PATIENT, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToReadyForSignOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_SEKRETESS, actualValue.getCode());
  }

  @Override
  protected void assertAllowToReadyForSignOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.DECEASED_PATIENT, actualValue.getCode());
  }
