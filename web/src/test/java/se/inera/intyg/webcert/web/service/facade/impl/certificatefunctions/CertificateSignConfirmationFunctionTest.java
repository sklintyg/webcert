...
class CertificateSignConfirmationFunctionTest {
  ...
  @InjectMocks private CertificateSignConfirmationFunctionImpl certificateSignConfirmationFunction;
  ...
  class DbType {
    ...
    void shallReturnResourceLinkIfSignedDodsbevisExistsForAnotherCareprovider() {
      ...
      final var previousIntygDifferentCareProvider =
          Map.of(
              INTYG_INDICATOR,
              Map.of(
                  DB_TYPE,
      ...
      doReturn(previousIntygDifferentCareProvider)
          .when(utkastService)
          .checkIfPersonHasExistingIntyg(PERSONNUMMER, webCertUser, CERTIFICATE_ID);

      final var actualResourceLink =
          certificateSignConfirmationFunction.get(dbCertificate, webCertUser);
    ...
    void shallReturnNullIfNoSignedDodsbevisExistsForAnotherCareprovider() {
      ...
      assertTrue(
          actualResourceLink.isEmpty(),
          "If no signed dodsbevis exist it should not return a resource link");
    }
    ...
    void shallReturnResourceLinkIfDraftDodsbevisExistsForAnotherCareprovider() {
      ...
      final var previousUtkastDifferentCareProvider =
          Map.of(
              UTKAST_INDICATOR,
              Map.of(
                  DB_TYPE,
    ...
    void shallReturnNullIfNoDraftNotDodsbevisExistsForAnotherCareprovider() {
      ...
      final var actualResourceLink =
          certificateSignConfirmationFunction.get(notDbCertificate, webCertUser);

      assertTrue(
          actualResourceLink.isEmpty(), "If not dodsbevis it should not return a resource link");
    }
  }
  ...
  class DoiType {
    ...
    void shallReturnResourceLinkIfDraftExistsFromAnotherCareprovider() {
      ...
      final var previousDraftDifferentCareProvider =
          Map.of(
              UTKAST_INDICATOR,
              Map.of(
                  DOI_TYPE,
      ...
      final var actualResourceLink =
          certificateSignConfirmationFunction.get(doiCertifcate, webCertUser);
    ...
    void shallReturnResourceLinkIfReplacedAndDraftDoiExistsForAnotherCareprovider() {
      ...
      final var previousCertificates =
          Map.of(
              INTYG_INDICATOR,
              Map.of(
                  DOI_TYPE,
