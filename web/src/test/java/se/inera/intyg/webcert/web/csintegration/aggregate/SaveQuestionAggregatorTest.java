...
class SaveQuestionAggregatorTest {
    ...
    @Mock
    SaveQuestionFacadeService createQuestionFromWC;
    @Mock
    SaveQuestionFacadeService createQuestionFromCS;
    @Mock
    ...
    void shallReturnQuestionFromWCIfCertificateServiceProfileIsInactive() {
        ...
        verify(createQuestionFromWC).save(QUESTION);
    ...
    void shallReturnQuestionFromWCIfCertificateServiceProfileIsActiveButResponseFromCSIsNull() {
        ...
        doReturn(null).when(createQuestionFromCS).save(QUESTION);
        doReturn(expectedQuestion).when(createQuestionFromWC).save(QUESTION);
    ...
    void shallReturnQuestionFromCSIfCertificateServiceProfileIsActiveAndResponseFromCSIsNotNull() {
        ...
        doReturn(true).when(certificateServiceProfile).active();
        doReturn(expectedQuestion).when(createQuestionFromCS).save(QUESTION);
