...
public class PatientDetailsResolverTest {
  ...
  public void init() throws Exception {
    ...
    when(moduleRegistry.getModuleApi("ts-diabetes", TS_DIABETES_VERSION_2))
        .thenReturn(new TsDiabetesModuleApiV2());
    when(moduleRegistry.getModuleApi("ts-diabetes", TS_DIABETES_VERSION_3))
        .thenReturn(new TsDiabetesModuleApiV3());
  ...
  public void testTSIntygIntegrationWithPuOkButAddressMissingFromIntegration() {
    ...
    when(integratedWebCertUser.getParameters())
        .thenReturn(buildIntegrationParametersWithNullAddress());
