...
class CreateUtkastCopyBuilderTest extends AbstractBuilderTest {
  ...
  void expectCallToModuleRegistry() throws Exception {
    ...
    when(moduleRegistry.getModuleApi(INTYG_TYPE_2, INTYG_TEXT_VERSION))
        .thenReturn(mockModuleApiDOI);
  }
  ...
  void testPopulateRenewalUtkastFromSignedIntyg() throws Exception {
    ...
    when(mockModuleApiDOI.createNewInternalFromTemplate(any(CreateDraftCopyHolder.class), any()))
    ...
    UtkastBuilderResponse builderResponse =
        createUtkastCopyBuilder.populateCopyUtkastFromSignedIntyg(
  ...
  void testPopulateCopyUtkastFromOriginalUtkast() throws Exception {
    ...
    UtkastBuilderResponse builderResponse =
        createUtkastCopyBuilder.populateCopyUtkastFromOrignalUtkast(
            createUtkastFromTemplateRequest, patientDetails, true);
