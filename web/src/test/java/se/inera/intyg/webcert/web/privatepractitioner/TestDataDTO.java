...
public class TestDataDTO {
  ...
  public static final List<CodeDTO> POSITIONS_DTO =
      List.of(
          new CodeDTO("203090", "Läkare legitimerad, annan"), new CodeDTO("201010", "Överläkare"));

  public static final List<CodeDTO> HEALTHCARE_SERVICE_TYPES_DTO =
      List.of(
          new CodeDTO("11", "Medicinsk verksamhet"), new CodeDTO("13", "Opererande verksamhet"));

  public static final List<CodeDTO> TYPE_OF_CARE_DTO =
      List.of(new CodeDTO("01", "Öppenvård"), new CodeDTO("02", "Slutenvård"));

  public static final List<CodeDTO> DR_KRANSTEGE_SPECIALITIES =
      List.of(new CodeDTO("32", "Klinisk fysiologi"), new CodeDTO("74", "Nukleärmedicin"));

  public static final List<CodeDTO> DR_KRANSTEGE_LICENSED_HEALTHCARE_PROFESSIONS =
      List.of(new CodeDTO("LK", "Läkare"));

  public static final PrivatePractitionerDetails DR_KRANSTEGE_REGISTRATION_REQUEST_DTO =
      kranstegeRegistrationRequest().build();
  public static final PrivatePractitionerDetails DR_KRANSTEGE_UPDATE_REQUEST_DTO =
      kranstegeUpdateRequest().build();
  public static final UpdatePrivatePractitionerRequest DR_KRANSTEGE_UPDATE_REQUEST_INTEGRATION_DTO =
      kranstegeRequestUpdate().build();
  public static final RegisterPrivatePractitionerRequest
      DR_KRANSTEGE_REGISTRATION_REQUEST_INTEGRATION_DTO = kranstegeRequestRegistration().build();

  public static final PrivatePractitionerConfigResponse PRIVATE_PRACTITIONER_CONFIG_DTO =
      PrivatePractitionerConfigResponse.builder()
          .positions(POSITIONS_DTO)
          .healthcareServiceTypes(HEALTHCARE_SERVICE_TYPES_DTO)
          .typeOfCare(TYPE_OF_CARE_DTO)
          .build();

  public static HospInformationResponse DR_KRANSTEGE_HOSP_INFORMATION_RESPONSE_DTO =
      HospInformationResponse.builder()
