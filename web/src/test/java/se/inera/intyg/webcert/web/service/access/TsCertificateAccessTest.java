...
public class TsCertificateAccessTest extends CertificateAccessTest {
  ...
  public TsCertificateAccessTest(String intygsTyp, AccessServiceTestData accessServiceTestData) {
  ...
  @Override
  protected void assertAllowToRenewOnDifferentCareProviderWhenIntygSameVGExists(
  ...
  @Override
  protected void assertAllowToCreateQuestionOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToCreateQuestionOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToCreateQuestionOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToAnswerComplementOnSekretessPatientOnSameUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerComplementOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerComplementOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerComplementOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerComplementOnRenewFalseOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToAnswerQuestionOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerQuestionOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerQuestionOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToAnswerAdminQuestionOnSekretessPatientOnSameUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerAdminQuestionOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerAdminQuestionOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerAdminQuestionOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerAdminQuestionOnRenewFalseOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToAnswerAdminQuestionNoConditionsDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSetComplementAsHandledWhenMissingSubscription(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetComplementAsHandledNotLatestMajorVersion(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSetComplementAsHandledOnSekretessPatientOnSameUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetComplementAsHandledOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetComplementAsHandledOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetComplementAsHandledOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetComplementAsHandledOnRenewFalseOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetComplementAsHandledNoConditionsDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSetQuestionAsHandledWhenMissingSubscription(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToSetQuestionAsHandledOnSekretessPatientOnSameUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetQuestionAsHandledOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetQuestionAsHandledOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetQuestionAsHandledOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetQuestionAsHandledOnRenewFalseOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToSetQuestionAsHandledNoConditionsDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToReadQuestionsOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToReadQuestionsOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
  ...
  @Override
  protected void assertAllowToForwardQuestionsOnSekretessPatientOnSameUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToForwardQuestionsOnSekretessPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToForwardQuestionsOnDeceasedPatientOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToForwardQuestionsOnInactiveUnitOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }

  @Override
  protected void assertAllowToForwardQuestionsOnRenewFalseOnDifferentUnit(
      AccessResult actualValue) {
    assertEquals(AccessResultCode.AUTHORIZATION_VALIDATION, actualValue.getCode());
  }
