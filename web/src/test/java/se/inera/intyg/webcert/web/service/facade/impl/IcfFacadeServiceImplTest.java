...
class IcfFacadeServiceImplTest {
  ...
  @Mock private IcfService icfService;

  @Mock private WebcertModuleService moduleService;

  @InjectMocks private IcfFacadeServiceImpl icfFacadeService;
  ...
  class CommonIcfCodes {
    ...
    void setUp() {
      ...
      doReturn(icfResponse).when(icfService).findIcfInformationByIcd10Koder(any());
    }
    ...
    void shallReturnResponseWithCommonActivityLimitationIcfCodes() {
      final var actual = icfFacadeService.getIcfInformation(createRequestDTO());
      assertEquals(
          icfResponse.getGemensamma().getAktivitetsBegransningsKoder().getIcfKoder().size(),
          actual.getDisability().getCommonCodes().getIcfCodes().size());
    }

    @Test
    void shallReturnResponseWithCommonActivityLimitationIcdCodes() {
      doReturn(icdTitle).when(moduleService).getDescriptionFromDiagnosKod(any(), any());

      final var actual = icfFacadeService.getIcfInformation(createRequestDTO());

      assertEquals(
          icfResponse.getGemensamma().getAktivitetsBegransningsKoder().getIcd10Koder().size(),
    ...
    void shallReturnResponseWithCommonDisabilityIcfCodes() {
      ...
      assertEquals(
          icfResponse.getGemensamma().getFunktionsNedsattningsKoder().getIcfKoder().size(),
          actual.getDisability().getCommonCodes().getIcfCodes().size());
    }
    ...
    void shallReturnResponseWithCommonDisabilityIcdCodes() {
      ...
      assertEquals(
          icfResponse.getGemensamma().getFunktionsNedsattningsKoder().getIcd10Koder().size(),
          actual.getDisability().getCommonCodes().getIcd10Codes().size());
    }
    ...
    void shallReturnResponseWithIcdTitle() {
      ...
      assertEquals(
          icdTitle, actual.getDisability().getCommonCodes().getIcd10Codes().get(0).getTitle());
    }
    ...
    void shallReturnResponseWithIcdCode() {
      ...
      assertEquals(
          icdCode, actual.getDisability().getCommonCodes().getIcd10Codes().get(0).getCode());
    }
    ...
    void shallReturnResponseWithIcfCode() {
      ...
      assertEquals(
          icfCodeObj.getKod(),
          actual.getActivityLimitation().getCommonCodes().getIcfCodes().get(0).getCode());
    }
    ...
    void shallReturnResponseWithIcfTitle() {
      ...
      assertEquals(
          icfCodeObj.getBenamning(),
          actual.getActivityLimitation().getCommonCodes().getIcfCodes().get(0).getTitle());
    }
    ...
    void shallReturnResponseWithIcfIncludes() {
      ...
      assertEquals(
          icfCodeObj.getInnefattar(),
          actual.getActivityLimitation().getCommonCodes().getIcfCodes().get(0).getIncludes());
    }
  ...
  class UniqueIcfCodes {
    ...
    void shallReturnResponseWithUniqueActivityLimitationIcfCodes() {
      final var actual = icfFacadeService.getIcfInformation(createRequestDTO());
      assertEquals(
          icfResponse.getUnika().get(0).getAktivitetsBegransningsKoder().getIcfKoder().size(),
    ...
    void shallReturnResponseWithUniqueActivityLimitationIcdCodes() {
      ...
      assertEquals(
          icfResponse.getUnika().get(0).getAktivitetsBegransningsKoder().getIcd10Koder().size(),
    ...
    void shallReturnResponseWithUniqueDisabilityIcfCodes() {
      ...
      assertEquals(
          icfResponse.getUnika().get(0).getFunktionsNedsattningsKoder().getIcfKoder().size(),
          actual.getDisability().getUniqueCodes().get(0).getIcfCodes().size());
    }
    ...
    void shallReturnResponseWithUniqueDisabilityIcdCodes() {
      ...
      assertEquals(
          icfResponse.getUnika().get(0).getFunktionsNedsattningsKoder().getIcd10Koder().size(),
          actual.getDisability().getUniqueCodes().get(0).getIcd10Codes().size());
    }
    ...
    void shallReturnResponseWithIcdTitle() {
      ...
      assertEquals(
          icdTitle,
          actual.getDisability().getUniqueCodes().get(0).getIcd10Codes().get(0).getTitle());
    }
    ...
    void shallReturnResponseWithIcdCode() {
      ...
      assertEquals(
          icdCode, actual.getDisability().getUniqueCodes().get(0).getIcd10Codes().get(0).getCode());
    }
    ...
    void shallReturnResponseWithIcfCode() {
      ...
      assertEquals(
          icfCodeObj.getKod(),
          actual.getActivityLimitation().getUniqueCodes().get(0).getIcfCodes().get(0).getCode());
    }
    ...
    void shallReturnResponseWithIcfTitle() {
      ...
      assertEquals(
          icfCodeObj.getBenamning(),
          actual.getActivityLimitation().getUniqueCodes().get(0).getIcfCodes().get(0).getTitle());
    }
  ...
  class MultipleIcfCodes {
    ...
    void setUp() {
      ...
      commonIcfCodeObj =
          IcfKod.of(
              commonIcfCodeFirst,
              commonIcfTitleFirst,
              commonIcfDescriptionFirst,
              commonIcfIncludesFirst);
      ...
      commonActivityLimitationCodes =
          AktivitetsBegransningsKoder.of(commonIcdCodes, commonIcfCodes);
      commonDiagnoskodResponse.setAktivitetsBegransningsKoder(commonActivityLimitationCodes);

      uniqueDiagnoskodResponse = new IcfDiagnoskodResponse();
      uniqueIcfCodeObjFirst =
          IcfKod.of(uniqueIcfCode, uniqueIcfTitle, uniqueIcfDescription, uniqueIcfIncludes);
      uniqueIcfCodeObjSecond =
          IcfKod.of(
              uniqueIcfCodeSecond,
              uniqueIcfTitleSecond,
              uniqueIcfDescriptionSecond,
      ...
      uniqueActivityLimitationCodes =
          AktivitetsBegransningsKoder.of(uniqueIcdCodes, uniqueIcfCodes);
    ...
    void shallReturnMultipleUniqueIcfCodesWithCorrectIcdCodes() {
      ...
      assertEquals(
          icfResponse.getUnika().get(0).getIcd10Kod(),
          actual.getDisability().getUniqueCodes().get(0).getIcd10Codes().get(0).getCode());
      assertEquals(
          icfResponse.getUnika().get(1).getIcd10Kod(),
