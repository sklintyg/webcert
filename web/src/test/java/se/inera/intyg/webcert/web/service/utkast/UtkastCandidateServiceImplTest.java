...
public class UtkastCandidateServiceImplTest {
  ...
  @Mock private Ag7804ModuleApiV1 ag7804ModuleApiV1Mock;

  @Mock private DoiModuleApiV1 doiModuleApiV1Mock;
  ...
  public void setup() {
    ...
    doAnswer(
        ...
        .isUserAllowedAccessToUnit(anyString());
  }
  ...
  public void getCandidateMetaDataWhenMatchingCriterias() {
    ...
    when(draftAccessServiceHelper.isAllowedToCopyFromCandidate(
            any(AccessEvaluationParameters.class)))
        .thenReturn(true);

    Optional<GetCopyFromCriteria> copyFromCriteria =
        Optional.of(new GetCopyFromCriteria(intygTypeCandidate, "1"));
    ...
    when(logRequestFactory.createLogRequestFromUtkast(any(Utkast.class), anyBoolean()))
    ...
    when(utkastRepository.findAllByPatientPersonnummerAndIntygsTypIn(
            patient.getPersonId().getPersonnummerWithDash(), validIntygType))
        .thenReturn(candidates);

    assertTrue(
        utkastCandidateService
            .getCandidateMetaData(
                ag7804ModuleApiV1Mock, intygType, intygTypeVersion, patient, false)
            .isPresent());
  ...
  public void getCandidateMetaDataWhenMissingCopyFromCriteria() {
    ...
    assertFalse(
        utkastCandidateService
            .getCandidateMetaData(
                ag7804ModuleApiV1Mock, utkastType, intygTypeVersion, patient, false)
            .isPresent());
  ...
  public void getCandidateMetaDataShouldSelectCorrectCandidateIntyg() {
    ...
    List<Utkast> candidates =
        Arrays.asList(
            createCandidate(
                UtkastStatus.DRAFT_COMPLETE, // Revoked status
                "correct-ve-hsaid",
                null,
                "bad-id-1",
                intygTypeCandidate,
                ...
                "correct-user-hsaid"),
            createCandidate(
                UtkastStatus.SIGNED, // Wrong version
                "correct-ve-hsaid",
                null,
                "bad-id-2",
                intygTypeCandidate,
                ...
                "correct-user-hsaid"),
            createCandidate(
                UtkastStatus.SIGNED, // Other enhetsid
                "bad-ve-hsa-id",
                null,
                "bad-id-2",
                intygTypeCandidate,
                ...
                "correct-user-hsaid"),
            createCandidate(
                UtkastStatus.SIGNED, // The one that should be selected
                "correct-ve-hsaid",
                null,
                "expected-intygsid",
                intygTypeCandidate,
                ...
                "correct-user-hsaid"),
            createCandidate(
                UtkastStatus.SIGNED, // Revoked yesterday
                "correct-ve-hsaid",
                LocalDateTime.now().minusDays(1),
                "bad-id-5",
                intygTypeCandidate,
  ...
  private Utkast createCandidate(
  ...
  private Patient createPatient(
      String fornamn, String efternamn, Personnummer personnummer, boolean sekretessmarkering) {
  ...
  private Personnummer createPnr(String pnr) {
    return Personnummer.createPersonnummer(pnr)
        .orElseThrow(
            () -> new IllegalArgumentException("Could not parse passed personnummer: " + pnr));
  }
  ...
  public void getDbCandidateMetaDataShouldReturnCorrectCandidate() {
    ...
    when(webCertUser.getValdVardgivare())
        .thenReturn(createSelectableVardenhet("same-care-giver-hsaid"));
    when(webCertUser.getValdVardenhet())
        .thenReturn(createSelectableVardenhet("same-care-unit-hsaid"));
    when(webCertUser.getHsaId()).thenReturn("correct-user-hsaid");
    ...
    List<Utkast> candidates =
        Arrays.asList(
            createDbCandidate(
                UtkastStatus.DRAFT_COMPLETE, // Draft status
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // Other care giver
                "same-care-unit-hsaid",
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // A revoked certificate
                "same-care-unit-hsaid",
                "same-care-giver-hsaid",
                LocalDateTime.now().minusDays(1),
                null,
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // A replaced certificate
                "same-care-unit-hsaid",
                "same-care-giver-hsaid",
                null,
                null,
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // Wrong certificate type version
                "same-care-unit-hsaid",
                "same-care-giver-hsaid",
                null,
                null,
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // Wrong certificate type
                "same-care-unit-hsaid",
                "same-care-giver-hsaid",
                null,
                null,
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // A valid certificate replacing certificate-id-4
                "same-care-unit-hsaid",
                "same-care-giver-hsaid",
                null,
                RelationKod.ERSATT,
                ...
                "correct-user-hsaid"),
            createDbCandidate(
                UtkastStatus.SIGNED, // A valid certificate, other care unit - should be returned in
                // metadata
    ...
    Optional<UtkastCandidateMetaData> metaData =
        utkastCandidateService.getCandidateMetaData(
            doiModuleApiV1Mock, intygType, intygTypeVersion, patient, false);
  ...
  // CHECKSTYLE:OFF ParameterNumber
  private Utkast createDbCandidate(
      UtkastStatus utkastStatus,
      String unitId,
      String careGiverId,
      LocalDateTime revokedDate,
