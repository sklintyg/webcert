...
class TestDataIntegration {
  ...
  public static final List<Code> DR_KRANSTEGE_SPECIALITIES =
      List.of(new Code("32", "Klinisk fysiologi"), new Code("74", "Nukleärmedicin"));
  public static final List<Code> DR_KRANSTEGE_LICENSED_HEALTHCARE_PROFESSIONS =
      List.of(new Code("LK", "Läkare"));

  public static final RegisterPrivatePractitionerRequest DR_KRANSTEGE_REGISTRATION_REQUEST =
      registerPrivatePractitionerRequest().build();
