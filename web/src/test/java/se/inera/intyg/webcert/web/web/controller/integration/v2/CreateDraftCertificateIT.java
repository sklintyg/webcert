...
public class CreateDraftCertificateIT {
    ...
    private static final String REQUEST_LUAENA = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:urn=\"urn:riv:itintegration:registry:1\" xmlns:urn1=\"urn:riv:clinicalprocess:healthcond:certificate:CreateDraftCertificateResponder:2\" xmlns:urn2=\"urn:riv:clinicalprocess:healthcond:certificate:types:2\" xmlns:urn3=\"urn:riv:clinicalprocess:healthcond:certificate:2\">\n" +
            "   <soapenv:Header>\n" +
            ...
            "         <urn1:intyg>\n" +
            "            <urn1:typAvIntyg>\n" +
            "               <urn2:code>luae_na</urn2:code>\n" +
            "               <urn2:codeSystem>f6fb361a-e31d-48b8-8657-99b63912dd9b</urn2:codeSystem>\n" +
            "               <!--Optional:-->\n" +
            "               <urn2:displayName>Läkarutlåtande Aktivitetsersättning vid Nedsatt Arbetsförmåga</urn2:displayName>\n" +
            "            </urn1:typAvIntyg>\n" +
            "            <urn1:patient>\n" +
            "               <urn3:person-id>\n" +
    ...
    public void testCreateLuaenaDraft() {
        ...
        given().with().body(REQUEST_LUAENA)
                .expect()
                .statusCode(200)
                .body(BASE + "result.resultCode", is("OK"))
                .body(BASE + "intygs-id.extension.size()", is(1)) // Expect one such element.
