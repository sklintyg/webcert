...
public class SignaturTicketTrackerTest {
    ...
    public void prune() {
        for (int i = 1; i < 100; i++) {
            tracker.trackTicket(new SignaturTicket("old-" + i, BEARBETAR, "intygid", "1234", new LocalDateTime().minusMinutes(6)));
            tracker.trackTicket(new SignaturTicket(String.valueOf(i), BEARBETAR, "intygid", "1234", new LocalDateTime()));
        }
    ...
    public void updateStatus() {
        tracker.trackTicket(new SignaturTicket("id", BEARBETAR, "intygid", "1234", new LocalDateTime()));
