...
public class TicketTrackerTest {
    ...
    public void prune() {
        for (int i = 1; i < 100; i++) {
            tracker.trackTicket(new SignatureTicket("old-" + i, BEARBETAR, "intygid", null, "1234", new LocalDateTime().minusMinutes(6)));
            tracker.trackTicket(new SignatureTicket(String.valueOf(i), BEARBETAR, "intygid", null, "1234", new LocalDateTime()));
        }
    ...
    public void updateStatus() {
        tracker.trackTicket(new SignatureTicket("id", BEARBETAR, "intygid", null, "1234", new LocalDateTime()));
