...
public class FmbStub {
    ...
    private void addHardcodedInfo(Typfall typfall) {
        ...
        try {
            ...
            attributes.getFmbtillstand().orElse(null).setDiagnoskod(Arrays.asList(getDiagnoskod("J22"), getDiagnoskod("J20")));
            data.add(copy);
        } catch (IOException e) {
    ...
    private void addHardcodedInfo(FmdxInformation fmdxInformation) {
        ...
        try {
            ...
            attributes.getAktivitetsbegransning().orElse(null).setBeskrivning("Akut bronkit påverkar inte "
            ...
            attributes.getFunktionsnedsattning().orElse(null).setBeskrivning("Tillståndet är vanligtvis "
            ...
            attributes.getForsakringsmedicinskinformation().orElse(null).setMarkup("Återkommande akuta bronkiter hos rökare bör "
            ...
            attributes.getSymtomprognosbehandling().orElse(null).setMarkup("Akut bronkit orsakas vanligen av luftvägsinflammation "
