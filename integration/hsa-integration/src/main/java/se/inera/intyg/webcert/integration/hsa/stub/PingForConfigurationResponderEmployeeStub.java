 ...
 */
@Component(value = "pingForConfigurationResponderInterfaceEmployee")
public class PingForConfigurationResponderEmployeeStub implements PingForConfigurationResponderInterface {
