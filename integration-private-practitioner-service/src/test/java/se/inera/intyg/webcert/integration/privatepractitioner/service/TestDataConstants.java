...
import se.inera.intyg.webcert.integration.privatepractitioner.model.LicensedHealthcareProfession;
import se.inera.intyg.webcert.integration.privatepractitioner.model.Speciality;
...
public class TestDataConstants {
    ...
    public static final List<LicensedHealthcareProfession> DR_KRANSTEGE_LICENSED_HEALTHCARE_PROFESSIONS =
        List.of(new LicensedHealthcareProfession("LK", "Läkare"));
