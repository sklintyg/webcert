...
import se.inera.intyg.webcert.integration.privatepractitioner.model.*;

import java.time.LocalDateTime;
import java.util.List;

import static se.inera.intyg.webcert.integration.privatepractitioner.service.testdata.TestDataConstants.*;
...
public class TestData {
    ...
    public static GetHospInformationRequest kranstegeHospInformationRequest() {
        return new GetHospInformationRequest(DR_KRANSTEGE_PERSON_ID);
    }
}
