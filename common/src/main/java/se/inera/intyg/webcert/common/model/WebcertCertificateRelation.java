...
/**
 * Encapsulates a single relation. Instances of this class should always exist in the context of a
 * {@link Relations} instance, either as parent relation or a child relation.
 *
 * <p>Created by eriklupander on 2017-05-17.
 */
public class WebcertCertificateRelation {

  /**
   * Given the context of a certficate, the intygsId always denotes the other certificate in the
   * relation.
   */
  private String intygsId;

  /**
   * The type of the relation. Note that the enumerations are bi-directional. E.g - an ERSATT is
   * used both for parent and child relations even though the swedish verbs would be: "Ersatt av"
   * and "Ersätter" respectively.
   */
  ...
  /**
   * Given the context of a certificate, this status always denotes the status of the target (other)
   * certificate.
   */
  ...
  public WebcertCertificateRelation(
      String intygsId, RelationKod relationKod, LocalDateTime skapad) {
