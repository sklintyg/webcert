...
class CertificateAnalyticsMessageFactoryTest {
  ...
  @Mock private LoggedInWebcertUserService loggedInWebcertUserService;

  @InjectMocks private CertificateAnalyticsMessageFactory factory;
  ...
  private static final CertificateRelationType CERTIFICATE_RELATION_PARENT_TYPE =
      CertificateRelationType.EXTENDED;
  ...
  class AnalyticsMessagesBasedOnCertificate {
    ...
    void setUp() {
      ...
      certificate.setMetadata(
          CertificateMetadata.builder()
              ...
              .patient(
                  Patient.builder()
                      .personId(PersonId.builder().id(CERTIFICATE_PATIENT_ID).build())
                      .build())
              .unit(Unit.builder().unitId(CERTIFICATE_UNIT_ID).build())
              .careProvider(Unit.builder().unitId(CERTIFICATE_CARE_PROVIDER_ID).build())
      ...
      lenient()
          .when(loggedInWebcertUserService.getLoggedInWebcertUser())
          .thenReturn(loggedInWebcertUser);
    ...
    void shallReturnCorrectCertificateRelationParentType(
      ...
      final var actual = test.apply(certificate);
      assertEquals(
          CERTIFICATE_RELATION_PARENT_TYPE.name(), actual.getCertificate().getParent().getType());
    }
    ...
    Stream<Arguments> analyticsMessagesBasedOnCertificate() {
      return Stream.of(
          ...
          Arguments.of(
              (Function<Certificate, CertificateAnalyticsMessage>)
                  certificate -> factory.draftCreatedFromCertificate(certificate),
              CertificateAnalyticsMessageType.DRAFT_CREATED_FROM_CERTIFICATE),
          Arguments.of(
              (Function<Certificate, CertificateAnalyticsMessage>)
                  certificate -> factory.draftUpdatedFromCertificate(certificate),
  ...
  class AnalyticsMessagesBasedOnCertificateWithoutLoggedInUser {
    ...
    void shallReturnCorrectEventTimestamp(
        Function<CertificateAndUser, CertificateAnalyticsMessage> test,
        CertificateAnalyticsMessageType messageType) {
    ...
    void shallReturnCorrectEventSessionId(
      ...
      final var actual = test.apply(CertificateAndUser.create(certificate, loggedInWebcertUser));
      assertNull(
          actual.getEvent().getSessionId(), "SessionId should be null when no user logged in");
    }
    ...
    Stream<Arguments> analyticsMessagesBasedOnCertificateWithoutLoggedInUser() {
      return Stream.of(
          Arguments.of(
              (Function<CertificateAndUser, CertificateAnalyticsMessage>)
                  certificateAndUser ->
                      factory.draftCreated(
                          certificateAndUser.certificate(), certificateAndUser.user()),
              CertificateAnalyticsMessageType.DRAFT_CREATED),
          Arguments.of(
              (Function<CertificateAndUser, CertificateAnalyticsMessage>)
                  certificateAndUser ->
                      factory.draftCreatedWithPrefill(
                          certificateAndUser.certificate(), certificateAndUser.user()),
  ...
  class AnalyticsMessagesBasedOnUtkast {
    ...
    void setUp() {
      ...
      utkast.setPatientPersonnummer(
          Personnummer.createPersonnummer(CERTIFICATE_PATIENT_ID).orElseThrow());
    ...
    void shallReturnCorrectEventTimestamp(
        Function<Utkast, CertificateAnalyticsMessage> test,
        CertificateAnalyticsMessageType messageType) {
    ...
    Stream<Arguments> analyticsMessagesBasedOnUtkast() {
      return Stream.of(
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftCreated(utkast),
              CertificateAnalyticsMessageType.DRAFT_CREATED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftDeleted(utkast),
              CertificateAnalyticsMessageType.DRAFT_DELETED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftDisposed(utkast),
              CertificateAnalyticsMessageType.DRAFT_DISPOSED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftUpdated(utkast),
              CertificateAnalyticsMessageType.DRAFT_UPDATED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftUpdatedFromCertificate(utkast),
              CertificateAnalyticsMessageType.DRAFT_UPDATED_FROM_CERTIFICATE),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftReadyForSign(utkast),
              CertificateAnalyticsMessageType.DRAFT_READY_FOR_SIGN),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.lockedDraftRevoked(utkast),
              CertificateAnalyticsMessageType.LOCKED_DRAFT_REVOKED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.draftCreatedFromCertificate(utkast),
              CertificateAnalyticsMessageType.DRAFT_CREATED_FROM_CERTIFICATE),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.certificateSigned(utkast),
              CertificateAnalyticsMessageType.CERTIFICATE_SIGNED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.certificateSent(utkast, utkast.getSkickadTillMottagare()),
              CertificateAnalyticsMessageType.CERTIFICATE_SENT),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.certificateRenewed(utkast),
              CertificateAnalyticsMessageType.CERTIFICATE_RENEWED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.certificateReplace(utkast),
              CertificateAnalyticsMessageType.CERTIFICATE_REPLACED),
          Arguments.of(
              (Function<Utkast, CertificateAnalyticsMessage>)
                  utkast -> factory.certificateComplemented(utkast),
              CertificateAnalyticsMessageType.CERTIFICATE_COMPLEMENTED));
    }
  }
  ...
  class AnalyticsMessagesBasedOnUtkastWithoutLoggedInUser {
    ...
    @MethodSource("analyticsMessagesBasedOnCertificateWithoutLoggedInUser")
    void shallReturnCorrectEventTimestamp(
        Function<UtkastAndUser, CertificateAnalyticsMessage> test,
        CertificateAnalyticsMessageType messageType) {
    ...
    Stream<Arguments> analyticsMessagesBasedOnCertificateWithoutLoggedInUser() {
      return Stream.of(
          Arguments.of(
              (Function<UtkastAndUser, CertificateAnalyticsMessage>)
                  utkastAndUser ->
          ...
          Arguments.of(
              (Function<UtkastAndUser, CertificateAnalyticsMessage>)
                  utkastAndUser ->
                      factory.draftCreatedWithPrefill(
                          utkastAndUser.certificate(), utkastAndUser.user()),
              CertificateAnalyticsMessageType.DRAFT_CREATED_WITH_PREFILL));
    }
  ...
  class AnalyticsMessagesBasedOnUtlatande {
    ...
    void setUp() {
      ...
      when(patient.getPersonId())
          .thenReturn(Personnummer.createPersonnummer(CERTIFICATE_PATIENT_ID).orElseThrow());
    ...
    void shallReturnCorrectEventTimestamp(
        Function<Utlatande, CertificateAnalyticsMessage> test,
        CertificateAnalyticsMessageType messageType) {
    ...
    Stream<Arguments> analyticsMessagesBasedOnUtlatande() {
      return Stream.of(
          Arguments.of(
              (Function<Utlatande, CertificateAnalyticsMessage>)
                  utlatande -> factory.certificatePrinted(utlatande),
              CertificateAnalyticsMessageType.CERTIFICATE_PRINTED),
          Arguments.of(
              (Function<Utlatande, CertificateAnalyticsMessage>)
                  utlatande -> factory.certificateRevoked(utlatande),
              CertificateAnalyticsMessageType.CERTIFICATE_REVOKED));
    }
  }
  ...
  class AnalyticsMessagesBasedOnIncomingMessages {
    ...
    void setUp() {
      ...
      incomingMessageBuilder =
          IncomingMessageRequestDTO.builder()
              .id(MESSAGE_ID)
      ...
      final var noLoggedInUser = LoggedInWebcertUser.builder().build();
    ...
    void shallReturnCorrectEventMessageTypeWhenAVSTMN() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.type(MessageTypeDTO.AVSTMN).build());
      assertEquals(
          CertificateAnalyticsMessageType.QUESTION_FROM_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventMessageTypeWhenOVRIGT() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.type(MessageTypeDTO.OVRIGT).build());
      assertEquals(
          CertificateAnalyticsMessageType.QUESTION_FROM_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventMessageTypeWhenKONTKT() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.type(MessageTypeDTO.KONTKT).build());
      assertEquals(
          CertificateAnalyticsMessageType.QUESTION_FROM_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventMessageTypeWhenKOMPLT() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.type(MessageTypeDTO.KOMPLT).build());
      assertEquals(
          CertificateAnalyticsMessageType.COMPLEMENT_FROM_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventMessageTypeWhenPAMINN() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.type(MessageTypeDTO.PAMINN).build());
      assertEquals(
          CertificateAnalyticsMessageType.REMINDER_FROM_RECIPIENT,
          actual.getEvent().getMessageType());
    }
      ...
      final var actual =
          factory.receivedMessage(
              ...
              incomingMessageBuilder
                  ...
                  .build());
      assertEquals(
          CertificateAnalyticsMessageType.ANSWER_FROM_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventStaffId() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertNull(
          actual.getEvent().getUserId(),
          "Event user id shall be null when received message since no user is logged in");
    }
    ...
    void shallReturnCorrectEventRole() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertNull(
          actual.getEvent().getRole(),
          "Event role shall be null when received message since no user is logged in");
    }
    ...
    void shallReturnCorrectEventUnitId() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertNull(
          actual.getEvent().getUnitId(),
          "Event unit id shall be null when received message since no user is logged in");
    }
    ...
    void shallReturnCorrectEventCareProviderId() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertNull(
          actual.getEvent().getCareProviderId(),
    ...
    void shallReturnCorrectEventOrigin() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertNull(
          actual.getEvent().getOrigin(),
          "Event origin shall be null when received message since no user is logged in");
    }
    ...
    void shallReturnCorrectEventSessionId() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertNull(
          actual.getEvent().getSessionId(),
          "Event session id shall be null when received message since no user is logged in");
    }
    ...
    void shallReturnCorrectAnswerId() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.answerMessageId(MESSAGE_ANSWER_ID).build());
    ...
    void shallReturnCorrectReminderId() {
      final var actual =
          factory.receivedMessage(
              certificate, incomingMessageBuilder.reminderMessageId(MESSAGE_REMINDER_ID).build());
    ...
    void shallReturnCorrectMessageLastDayAnswer() {
      final var actual = factory.receivedMessage(certificate, incomingMessage);
      assertEquals(
          incomingMessage.getLastDateToAnswer(), actual.getMessage().getLastDateToAnswer());
    }
      ...
      final var actual =
          factory.receivedMessage(
              ...
              incomingMessageBuilder
                  .complements(
                      expected.stream()
                          .map(id -> IncomingComplementDTO.builder().questionId(id).build())
                          .toList())
                  .build());
  ...
  class AnalyticsMessagesBasedOnSentQuestions {
    ...
    void shallReturnCorrectEventMessageTypeWhenAVSTMN() {
      final var actual =
          factory.sentMessage(certificate, questionBuilder.type(QuestionType.COORDINATION).build());
      assertEquals(
          CertificateAnalyticsMessageType.QUESTION_TO_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventMessageTypeWhenOVRIGT() {
      final var actual =
          factory.sentMessage(certificate, questionBuilder.type(QuestionType.OTHER).build());
      assertEquals(
          CertificateAnalyticsMessageType.QUESTION_TO_RECIPIENT,
          actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectEventMessageTypeWhenKONTKT() {
      final var actual =
          factory.sentMessage(certificate, questionBuilder.type(QuestionType.CONTACT).build());
      assertEquals(
          CertificateAnalyticsMessageType.QUESTION_TO_RECIPIENT,
          actual.getEvent().getMessageType());
    }
      ...
      final var actual =
          factory.sentMessage(
              ...
              questionBuilder
                  ...
                  .build());
      assertEquals(
          CertificateAnalyticsMessageType.ANSWER_TO_RECIPIENT, actual.getEvent().getMessageType());
    }
    ...
    void shallReturnCorrectMessageTypeWhenComplement() {
      final var actual =
          factory.sentMessage(certificate, questionBuilder.type(QuestionType.COMPLEMENT).build());
      ...
      final var actual =
          factory.sentMessage(
              ...
              questionBuilder
                  .complements(
                      new Complement[] {
                        Complement.builder().questionId("complement-question-id").build()
                      })
                  .build());
      assertNull(
          actual.getMessage().getQuestionIds(),
