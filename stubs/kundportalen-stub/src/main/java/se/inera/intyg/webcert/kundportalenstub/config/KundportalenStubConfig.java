...
package se.inera.intyg.webcert.kundportalenstub.config;
...
import se.inera.intyg.webcert.kundportalenstub.api.KundportalenStubRestApi;
import se.inera.intyg.webcert.kundportalenstub.api.KundportalenStubSettingsApi;

@Configuration
@ComponentScan(basePackages = "se.inera.intyg.webcert.kundportalenstub")
