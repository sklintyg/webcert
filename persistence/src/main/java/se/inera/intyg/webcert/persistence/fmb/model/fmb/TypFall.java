...
public class TypFall {
  ...
  public static final class TypFallBuilder {
    ...
    public TypFallBuilder maximalSjukrivningstidSourceValue(
        String maximalSjukrivningstidSourceValue) {
      this.maximalSjukrivningstidSourceValue = maximalSjukrivningstidSourceValue;
      return this;
    }

    public TypFallBuilder maximalSjukrivningstidSourceUnit(
        String maximalSjukrivningstidSourceUnit) {
      this.maximalSjukrivningstidSourceUnit = maximalSjukrivningstidSourceUnit;
      return this;
    }
