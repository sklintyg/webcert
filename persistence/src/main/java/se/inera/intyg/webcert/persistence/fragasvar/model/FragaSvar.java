...
public class FragaSvar {
  ...
  /**
   * Tvinga laddning av refererade objeckt utan att använda FetchType.EAGER. Fixar bug WEBCERT-464
   * vilken duplicerade Komplettering för varje externaKontakter då vi fick multipla left outer
   * joins.
   */
  @PostLoad
  ...
  /**
   * Return latest event for this FragaSvar. If no svarsDatum has been set, the fragaSkickadDatum is
   * considered the lastest event.
   *
   * @return lastest date
   */
