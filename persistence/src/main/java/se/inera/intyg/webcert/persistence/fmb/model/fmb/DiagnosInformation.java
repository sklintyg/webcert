...
public final class DiagnosInformation {
  ...
  public static final class DiagnosInformationBuilder {
    ...
    public DiagnosInformationBuilder forsakringsmedicinskInformation(
        String forsakringsmedicinskInformation) {
      this.forsakringsmedicinskInformation = forsakringsmedicinskInformation;
      return this;
    }
    ...
    public DiagnosInformationBuilder informationOmRehabilitering(
        String informationOmRehabilitering) {
      this.informationOmRehabilitering = informationOmRehabilitering;
      return this;
    }
