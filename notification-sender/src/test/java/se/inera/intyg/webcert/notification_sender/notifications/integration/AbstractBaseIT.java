...
public abstract class AbstractBaseIT {
    ...
    @Autowired
    protected Fk7263InternalToNotification mockFk7263Transform;
    ...
    @Autowired
    protected CertificateStatusUpdateForCareResponderStub certificateStatusUpdateForCareResponderStub;

    @Autowired
    protected se.inera.intyg.webcert.notification_sender.mocks.v3.CertificateStatusUpdateForCareResponderStub certificateStatusUpdateForCareResponderV3;
    ...
    void setupConverter() throws ModuleException {
