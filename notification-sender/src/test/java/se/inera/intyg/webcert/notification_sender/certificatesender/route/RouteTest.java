...
@MockEndpointsAndSkip(
    "bean:certificateStoreProcessor|bean:certificateSendProcessor|bean:certificateRevokeProcessor|bean:sendMessageToRecipientProcessor|direct:certPermanentErrorHandlerEndpoint|direct:certTemporaryErrorHandlerEndpoint")
class RouteTest {
  ...
  void testNormalStoreRoute() throws InterruptedException {
    ...
    producerTemplate.sendBodyAndHeaders(
        MESSAGE_BODY, ImmutableMap.of(Constants.MESSAGE_TYPE, Constants.STORE_MESSAGE));
  ...
  void testNormalSendRoute() throws InterruptedException {
    ...
    producerTemplate.sendBodyAndHeaders(
        MESSAGE_BODY, ImmutableMap.of(Constants.MESSAGE_TYPE, Constants.SEND_MESSAGE));
  ...
  void testNormalRevokeRoute() throws InterruptedException {
    ...
    producerTemplate.sendBodyAndHeaders(
        MESSAGE_BODY, ImmutableMap.of(Constants.MESSAGE_TYPE, Constants.REVOKE_MESSAGE));
  ...
  void testNormalSendMessageRoute() throws InterruptedException {
    ...
    producerTemplate.sendBodyAndHeaders(
        MESSAGE_BODY, ImmutableMap.of(Constants.MESSAGE_TYPE, Constants.SEND_MESSAGE_TO_RECIPIENT));
  ...
  void testUnknownMessageType() throws InterruptedException {
    ...
    producerTemplate.sendBodyAndHeaders(
        MESSAGE_BODY, ImmutableMap.of(Constants.MESSAGE_TYPE, "non-existant"));
  ...
  void testPermanentException() throws InterruptedException {
    sendProcessor.whenAnyExchangeReceived(
        exchange -> {
  ...
  void testTemporaryException() throws InterruptedException {
    revokeProcessor.whenAnyExchangeReceived(
        exchange -> {
  ...
  void shallHandleUnexpectedExceptionAsTemporaryError() throws InterruptedException {
    storeProcessor.whenAnyExchangeReceived(
        exchange -> {
