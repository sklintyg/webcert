...
public class NotificationMessageDiscardFilterTest {
  ...
  public void testReturnsLatestSaved() throws IOException {
    ...
    NotificationMessage nm2 =
        buildNotificationMessage(
            intygsId, HandelsekodEnum.ANDRAT, LocalDateTime.now().minusSeconds(10));
    NotificationMessage nm1 = buildNotificationMessage(intygsId, HandelsekodEnum.ANDRAT, first);
    NotificationMessage nm3 =
        buildNotificationMessage(
            intygsId, HandelsekodEnum.ANDRAT, LocalDateTime.now().minusSeconds(15));
  ...
  private NotificationMessage buildNotificationMessage(
      String intygsId, HandelsekodEnum ht, LocalDateTime tid) {
