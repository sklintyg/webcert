...
public class MonitoringLogServiceImpl implements MonitoringLogService {
  ...
  @Override
  public void logStatusUpdateForCareStatusSuccess(
      long eventId,
      String eventType,
    ...
    try (MdcCloseableMap ignored =
        setMdc(eventId, eventType, unitId, certificateId, correlationId, sendAttempt)
            .put(
                ...
                toEventType(MonitoringEvent.STATUS_UPDATE_RESULT_SUCCESS))
            .build()) {
      logEvent(
          MonitoringEvent.STATUS_UPDATE_RESULT_SUCCESS,
          sendAttempt,
          certificateId,
          correlationId,
          unitId,
  ...
  public void logStatusUpdateForCareStatusResend(
      long eventId,
      String eventType,
      String unitId,
      String certificateId,
    ...
    try (MdcCloseableMap ignored =
        setMdc(eventId, eventType, unitId, certificateId, correlationId, sendAttempt)
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.STATUS_UPDATE_RESULT_RESEND))
            .put(MdcLogConstants.ERROR_CODE, errorCode)
            .put(MdcLogConstants.ERROR_MESSAGE, message)
            .build()) {
      logEvent(
          MonitoringEvent.STATUS_UPDATE_RESULT_RESEND,
          sendAttempt,
          certificateId,
          correlationId,
          unitId,
  ...
  @Override // CHECKSTYLE:OFF ParameterNumber
  public void logStatusUpdateForCareStatusFailure(
      long eventId,
      String eventType,
      String unitId,
      String certificateId,
    ...
    try (MdcCloseableMap ignored =
        setMdc(eventId, eventType, unitId, certificateId, correlationId, sendAttempt)
            .put(
                MdcLogConstants.EVENT_ACTION,
                toEventType(MonitoringEvent.STATUS_UPDATE_RESULT_FAILURE))
            .put(MdcLogConstants.ERROR_CODE, errorCode)
            .put(MdcLogConstants.ERROR_MESSAGE, message)
            .build()) {
      logEvent(
          MonitoringEvent.STATUS_UPDATE_RESULT_FAILURE,
          sendAttempt,
          certificateId,
          correlationId,
          unitId,
  ...
  private MdcCloseableMap.Builder setMdc(
      long eventId,
      String eventType,
      String unitId,
      String certificateId,
